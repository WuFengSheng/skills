[Skip to main content](https://java-design-patterns.com/patterns/execute-around/#main-content)

# Execute Around Pattern in Java: Encapsulating Pre and Post Execution Steps
