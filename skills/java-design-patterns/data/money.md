[Skip to main content](https://java-design-patterns.com/patterns/money/#main-content)

# Money Pattern in Java: Encapsulating Monetary Values with Currency Consistency
