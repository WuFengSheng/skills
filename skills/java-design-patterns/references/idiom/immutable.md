---
name: "immutable"
description: "Immutable 不可变 -- Idiom设计模式。Learn the Immutable pattern in Java with real-world examples, class diagrams, and tutorials. Understand how to create objects that cannot be modified "
url: "https://java-design-patterns.com/patterns/immutable/"
category: "idiom"
tags: [Object composition, Concurrency, Thread safety, Immutability]
---

# Immutable 不可变模式

> 官方文档: https://java-design-patterns.com/patterns/immutable/
> 分类: Idiom (idiom)
> 标签: Object composition, Concurrency, Thread safety, Immutability

IdiomImmutabilityThread safetyConcurrencyObject compositionAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/immutable/#also-known-as)

Value Object (when applied strictly to small domain values)

## [Intent of Immutable Design Pattern](https://java-design-patterns.com/patterns/immutable/#intent-of-immutable-design-pattern)
...
## [Detailed Explanation of Immutable Pattern with Real-World Examples](https://java-design-patterns.com/patterns/immutable/#detailed-explanation-of-immutable-pattern-with-real-world-examples)
...
## [Programmatic Example of Immutable Pattern in Java](https://java-design-patterns.com/patterns/immutable/#programmatic-example-of-immutable-pattern-in-java)
...
## [When to Use the Immutable Pattern in Java](https://java-design-patterns.com/patterns/immutable/#when-to-use-the-immutable-pattern-in-java)
...
## [Real-World Applications of Immutable Pattern in Java](https://java-design-patterns.com/patterns/immutable/#real-world-applications-of-immutable-pattern-in-java)
...
## [Benefits and Trade-offs of Immutable Pattern](https://java-design-patterns.com/patterns/immutable/#benefits-and-trade-offs-of-immutable-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/immutable/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/immutable/#references-and-credits)
