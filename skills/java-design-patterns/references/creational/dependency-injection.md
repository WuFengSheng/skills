...
description: "Dependency Injection 依赖注入 -- Creational设计模式。Learn about the Dependency Injection design pattern. Explore its benefits, real-world examples, class diagrams, and best practices for implementation "
url: "https://java-design-patterns.com/patterns/dependency-injection/"
category: "creational"
tags: [Inversion of control, Dependency management, Decoupling]
---

# Dependency Injection 依赖注入模式

> 官方文档: https://java-design-patterns.com/patterns/dependency-injection/
> 分类: Creational (creational)
> 标签: Inversion of control, Dependency management, Decoupling

CreationalDecouplingDependency managementInversion of controlAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/dependency-injection/#also-known-as)

- Inversion of Control (IoC)
- Dependency Inversion

## [Intent of Dependency Injection Design Pattern](https://java-design-patterns.com/patterns/dependency-injection/#intent-of-dependency-injection-design-pattern)

To decouple the creation of object dependencies from their usage, allowing for more flexible and testable code.

## [Detailed Explanation of Dependency Injection Pattern with Real-World Examples](https://java-design-patterns.com/patterns/dependency-injection/#detailed-explanation-of-dependency-injection-pattern-with-real-world-examples)
...
![Dependency Injection sequence diagram](https://java-design-patterns.com/assets/img/dependency-injection-sequence-diagram.2c470262.png)

## [Programmatic Example of Dependency Injection Pattern in Java](https://java-design-patterns.com/patterns/dependency-injection/#programmatic-example-of-dependency-injection-pattern-in-java)
...
## [When to Use the Dependency Injection Pattern in Java](https://java-design-patterns.com/patterns/dependency-injection/#when-to-use-the-dependency-injection-pattern-in-java)
...
## [Real-World Applications of Dependency Injection Pattern in Java](https://java-design-patterns.com/patterns/dependency-injection/#real-world-applications-of-dependency-injection-pattern-in-java)
...
## [Benefits and Trade-offs of Dependency Injection Pattern](https://java-design-patterns.com/patterns/dependency-injection/#benefits-and-trade-offs-of-dependency-injection-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/dependency-injection/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/dependency-injection/#references-and-credits)
