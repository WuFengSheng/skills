---
name: "factory-method"
description: "Factory Method 工厂方法 -- Creational设计模式。Learn about the Factory Method pattern in Java. Explore examples, uses, benefits, and how it enhances code flexibility and maintenance."
url: "https://java-design-patterns.com/patterns/factory-method/"
category: "creational"
tags: [Polymorphism, Object composition, Instantiation, Gang of Four, Encapsulation]
---

# Factory Method 工厂方法模式

> 官方文档: https://java-design-patterns.com/patterns/factory-method/
> 分类: Creational (creational)
> 标签: Polymorphism, Object composition, Instantiation, Gang of Four, Encapsulation

CreationalEncapsulationGang of FourInstantiationObject compositionPolymorphismAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/factory-method/#also-known-as)

- Virtual Constructor

## [Intent of Factory Method Design Pattern](https://java-design-patterns.com/patterns/factory-method/#intent-of-factory-method-design-pattern)
...
## [Detailed Explanation of Factory Method Pattern with Real-World Examples](https://java-design-patterns.com/patterns/factory-method/#detailed-explanation-of-factory-method-pattern-with-real-world-examples)
...
![Factory Method sequence diagram](https://java-design-patterns.com/assets/img/factory-method-sequence-diagram.6d24f1dc.png)

## [Programmatic Example of Factory Method Pattern in Java](https://java-design-patterns.com/patterns/factory-method/#programmatic-example-of-factory-method-pattern-in-java)
...
## [When to Use the Factory Method Pattern in Java](https://java-design-patterns.com/patterns/factory-method/#when-to-use-the-factory-method-pattern-in-java)
...
## [Real-World Applications of Factory Method Pattern in Java](https://java-design-patterns.com/patterns/factory-method/#real-world-applications-of-factory-method-pattern-in-java)
...
## [Benefits and Trade-offs of Factory Method Pattern](https://java-design-patterns.com/patterns/factory-method/#benefits-and-trade-offs-of-factory-method-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/factory-method/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/factory-method/#references-and-credits)
