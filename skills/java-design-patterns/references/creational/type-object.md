---
name: "type-object"
description: "Type Object 类型对象 -- Creational设计模式。Discover how the Type Object Pattern in Java allows for dynamic and flexible class creation without altering existing code. Ideal for developers looki"
url: "https://java-design-patterns.com/patterns/type-object/"
category: "creational"
tags: [Polymorphism, Object composition, Instantiation, Extensibility, Game programming, Data processing, Code simplification, Abstraction]
---

# Type Object 类型对象模式

> 官方文档: https://java-design-patterns.com/patterns/type-object/
> 分类: Creational (creational)
> 标签: Polymorphism, Object composition, Instantiation, Extensibility, Game programming, Data processing, Code simplification, Abstraction

CreationalAbstractionCode simplificationData processingGame programmingExtensibilityInstantiationObject compositionPolymorphismAbout 6 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/type-object/#also-known-as)

- Type Descriptor
- Type Safe Enumeration

## [Intent of Type Object Design Pattern](https://java-design-patterns.com/patterns/type-object/#intent-of-type-object-design-pattern)

Allow creation of flexible and extensible sets of related types.

## [Detailed Explanation of Type Object Pattern with Real-World Examples](https://java-design-patterns.com/patterns/type-object/#detailed-explanation-of-type-object-pattern-with-real-world-examples)
...
[gameprogrammingpatterns.com](http://gameprogrammingpatterns.com/) says

> Define a type object class and a typed object class. Each type object instance represents a different logical type. Each typed object stores a reference to the type object that describes its type.

Flowchart

![Type Object Pattern Flowchart](https://java-design-patterns.com/assets/img/type-object-flowchart.1100754c.png)

## [Programmatic Example of Type Object Pattern in Java](https://java-design-patterns.com/patterns/type-object/#programmatic-example-of-type-object-pattern-in-java)
...
02. The game enters a loop that continues until either the player has won enough points (`pointsWon >= toWin`) or the time limit has been reached (`end - start < givenTime`).

03. At the start of each round, a new `CellPool` and `CandyGame` are created. The `CellPool` is initialized with a size based on the number of cells in the game grid (`numOfRows * numOfRows + 5`). The `CandyGame` is initialized with the number of rows and the `CellPool`.

04. If it's not the first round, a message "Refreshing.." is logged. If it is the first round, a message "Starting game.." is logged.

05. The current game status is printed by calling `cg.printGameStatus()`.

06. The `end` time is updated to the current system time.

07. The game round is played by calling `cg.round((int) (end - start), givenTime)`. The elapsed time and the time limit are passed as arguments.

08. The points won in the round are added to the total points.

09. The `end` time is updated again to the current system time.
...
## [When to Use the Type Object Pattern in Java](https://java-design-patterns.com/patterns/type-object/#when-to-use-the-type-object-pattern-in-java)
...
## [Type Object Pattern Java Tutorials](https://java-design-patterns.com/patterns/type-object/#type-object-pattern-java-tutorials)

- [Types as Objects Pattern (Jon Pearce)](http://www.cs.sjsu.edu/~pearce/modules/patterns/analysis/top.htm)

## [Real-World Applications of Type Object Pattern in Java](https://java-design-patterns.com/patterns/type-object/#real-world-applications-of-type-object-pattern-in-java)
...
## [Benefits and Trade-offs of Type Object Pattern](https://java-design-patterns.com/patterns/type-object/#benefits-and-trade-offs-of-type-object-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/type-object/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/type-object/#references-and-credits)
