...
description: "Anti-Corruption Layer 防腐层 -- 设计模式。Anti-Corruption Layer 设计模式 Java 实现"
...
> 官方文档: https://java-design-patterns.com/patterns/anti-corruption-layer/
> 分类:  (integration)


IntegrationArchitectureDecouplingIntegrationIsolationLayered architectureMigrationModernizationRefactoringWrappingAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/anti-corruption-layer/#also-known-as)

- ACL
- Interface layer
- Translation layer

## [Intent of Anti-Corruption Layer Design Pattern](https://java-design-patterns.com/patterns/anti-corruption-layer/#intent-of-anti-corruption-layer-design-pattern)
...
## [Detailed Explanation of Anti-Corruption Layer Pattern with Real-World Examples](https://java-design-patterns.com/patterns/anti-corruption-layer/#detailed-explanation-of-anti-corruption-layer-pattern-with-real-world-examples)
...
![Anti-Corruption Layer sequence diagram](https://java-design-patterns.com/assets/img/anti-corruption-layer-sequence-diagram.79bfaa6e.png)

## [Programmatic Example of Anti-Corruption Layer Pattern in Java](https://java-design-patterns.com/patterns/anti-corruption-layer/#programmatic-example-of-anti-corruption-layer-pattern-in-java)
...
## [When to Use the Anti-Corruption Layer Pattern in Java](https://java-design-patterns.com/patterns/anti-corruption-layer/#when-to-use-the-anti-corruption-layer-pattern-in-java)
...
## [Anti-Corruption Layer Pattern Java Tutorials](https://java-design-patterns.com/patterns/anti-corruption-layer/#anti-corruption-layer-pattern-java-tutorials)
...
## [Real-World Applications of Anti-Corruption Layer Pattern in Java](https://java-design-patterns.com/patterns/anti-corruption-layer/#real-world-applications-of-anti-corruption-layer-pattern-in-java)
...
## [Benefits and Trade-offs of Anti-Corruption Layer Pattern](https://java-design-patterns.com/patterns/anti-corruption-layer/#benefits-and-trade-offs-of-anti-corruption-layer-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/anti-corruption-layer/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/anti-corruption-layer/#references-and-credits)
