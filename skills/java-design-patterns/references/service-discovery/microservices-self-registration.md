---
name: "microservices-self-registration"
description: "Microservices Self-Registration 自注册 -- Service Discovery设计模式。Dynamically register and discover Java microservices using Spring Boot and Eureka for resilient, scalable communication."
url: "https://java-design-patterns.com/patterns/microservices-self-registration/"
category: "service-discovery"
tags: [Resilience, Dynamic Configuration, Java, Spring Cloud, Spring Boot, Eureka, Service Discovery, Self-Registration]
---

# Microservices Self-Registration 自注册模式

> 官方文档: https://java-design-patterns.com/patterns/microservices-self-registration/
> 分类: Service Discovery (service-discovery)
> 标签: Resilience, Dynamic Configuration, Java, Spring Cloud, Spring Boot, Eureka, Service Discovery, Self-Registration

Service DiscoveryMicroservicesSelf-RegistrationService DiscoveryEurekaSpring BootSpring CloudJavaDynamic ConfigurationResilienceAbout 6 min

* * *

## [Intent of Microservices Self-Registration Pattern](https://java-design-patterns.com/patterns/microservices-self-registration/#intent-of-microservices-self-registration-pattern)
...
## [What's in the Project](https://java-design-patterns.com/patterns/microservices-self-registration/#what-s-in-the-project)
...
### [Project Structure](https://java-design-patterns.com/patterns/microservices-self-registration/#project-structure)
...
## [Steps to use for this Project](https://java-design-patterns.com/patterns/microservices-self-registration/#steps-to-use-for-this-project)
...
- Open your web browser and go to [http://localhost:8761/](http://localhost:8761/). You should see the Eureka Server dashboard. Initially, the list of registered instances will be empty.
...
- Run the Greeting Service
  ...
  - Go back to your Eureka Server dashboard in the browser ( [http://localhost:8761/](http://localhost:8761/)). You should now see GREETINGSERVICE listed under the "Instances currently registered with Eureka". Its status should be "UP".
...
- Run the Context Service
  ...
  - Go back to your Eureka Server dashboard in the browser ( [http://localhost:8761/](http://localhost:8761/)). You should now see CONTEXTSERVICE listed under the "Instances currently registered with Eureka". Its status should be "UP".

     STEP :
  - Test the Greeting Service Directly: Open your web browser and go to [http://localhost:8081/greeting](http://localhost:8081/greeting). You should see the output: Hello.
  - Test the Context Service (which calls the Greeting Service): Open your web browser and go to [http://localhost:8082/context](http://localhost:8082/context). You should see the output: The Greeting Service says: Hello from Chennai, Tamil Nadu, India!. This confirms that the Context Service successfully discovered and called the Greeting Service through Eureka.

Optional: Check Health Endpoints

You can also verify the health status of each service using Spring Boot Actuator:

- Greeting Service Health: [http://localhost:8081/actuator/health](http://localhost:8081/actuator/health) (should return {"status":"UP"})
- Context Service Health: [http://localhost:8082/actuator/health](http://localhost:8082/actuator/health) (should return {"status":"UP"})
- Eureka Server Health: [http://localhost:8761/actuator/health](http://localhost:8761/actuator/health) (should return {"status":"UP"})

## [When to use Microservices Self-Registration Pattern](https://java-design-patterns.com/patterns/microservices-self-registration/#when-to-use-microservices-self-registration-pattern)
...
## [Real-World Applications of Self-Registration pattern](https://java-design-patterns.com/patterns/microservices-self-registration/#real-world-applications-of-self-registration-pattern)
...
## [Advantages](https://java-design-patterns.com/patterns/microservices-self-registration/#advantages)
...
## [Trade-offs](https://java-design-patterns.com/patterns/microservices-self-registration/#trade-offs)
...
## [References](https://java-design-patterns.com/patterns/microservices-self-registration/#references)

- Microservices Patterns: [https://microservices.io/](https://microservices.io/)
- Eureka Documentation: [https://github.com/Netflix/eureka](https://github.com/Netflix/eureka) \| [https://spring.io/projects/spring-cloud-netflix](https://spring.io/projects/spring-cloud-netflix)
- Spring Boot Documentation: [https://spring.io/projects/spring-boot](https://spring.io/projects/spring-boot)
- Spring Cloud OpenFeignDocumentation: [https://spring.io/projects/spring-cloud-openfeign](https://spring.io/projects/spring-cloud-openfeign)
- Spring Boot Actuator Documentation: [https://www.baeldung.com/spring-boot-actuators](https://www.baeldung.com/spring-boot-actuators)
