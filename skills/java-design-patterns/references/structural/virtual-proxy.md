---
name: "virtual-proxy"
description: "Virtual Proxy 虚拟代理 -- Structural设计模式。Explore the Virtual Proxy Design Pattern in Java to improve your applications. Learn how this pattern optimizes performance and manages resources effi"
url: "https://java-design-patterns.com/patterns/virtual-proxy/"
category: "structural"
tags: [Lazy initialization, Decoupling, Caching]
---

# Virtual Proxy 虚拟代理模式

> 官方文档: https://java-design-patterns.com/patterns/virtual-proxy/
> 分类: Structural (structural)
> 标签: Lazy initialization, Decoupling, Caching

StructuralCachingDecouplingLazy initializationAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/virtual-proxy/#also-known-as)

- Lazy Initialization Proxy
- Virtual Surrogate

## [Intent of Virtual Proxy Design Pattern](https://java-design-patterns.com/patterns/virtual-proxy/#intent-of-virtual-proxy-design-pattern)
...
## [Detailed Explanation of Virtual Proxy Pattern with Real-World Examples](https://java-design-patterns.com/patterns/virtual-proxy/#detailed-explanation-of-virtual-proxy-pattern-with-real-world-examples)
...
![Virtual Proxy Sequence Diagram](https://java-design-patterns.com/assets/img/virtual-proxy-sequence-diagram.bce40486.png)

## [Programmatic Example of Virtual Proxy Pattern in Java](https://java-design-patterns.com/patterns/virtual-proxy/#programmatic-example-of-virtual-proxy-pattern-in-java)
...
## [When to Use the Virtual Proxy Pattern in Java](https://java-design-patterns.com/patterns/virtual-proxy/#when-to-use-the-virtual-proxy-pattern-in-java)
...
## [Virtual Proxy Pattern Java Tutorials](https://java-design-patterns.com/patterns/virtual-proxy/#virtual-proxy-pattern-java-tutorials)

- [The Proxy Pattern in Java (Baeldung)](https://www.baeldung.com/java-proxy-pattern)

## [Real-World Applications of Virtual Proxy Pattern in Java](https://java-design-patterns.com/patterns/virtual-proxy/#real-world-applications-of-virtual-proxy-pattern-in-java)
...
## [Benefits and Trade-offs of Virtual Proxy Pattern](https://java-design-patterns.com/patterns/virtual-proxy/#benefits-and-trade-offs-of-virtual-proxy-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/virtual-proxy/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/virtual-proxy/#references-and-credits)
