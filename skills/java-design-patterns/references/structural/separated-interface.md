...
description: "Separated Interface 分离接口 -- Structural设计模式。Explore the Separated Interface design pattern in Java: Enhance software flexibility and maintainability by decoupling interfaces from implementations"
url: "https://java-design-patterns.com/patterns/separated-interface/"
category: "structural"
tags: [Interface, Decoupling, API design]
---

# Separated Interface 分离接口模式

> 官方文档: https://java-design-patterns.com/patterns/separated-interface/
> 分类: Structural (structural)
> 标签: Interface, Decoupling, API design
