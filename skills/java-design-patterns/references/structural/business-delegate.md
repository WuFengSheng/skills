...
description: "Business Delegate 业务代表 -- Structural设计模式。Learn about the Business Delegate pattern in Java. This design pattern adds an abstraction layer between presentation and business tiers, ensuring loo"
url: "https://java-design-patterns.com/patterns/business-delegate/"
category: "structural"
tags: [Layered architecture, Enterprise patterns, Delegation, Decoupling, Business]
---

# Business Delegate 业务代表模式

> 官方文档: https://java-design-patterns.com/patterns/business-delegate/
> 分类: Structural (structural)
> 标签: Layered architecture, Enterprise patterns, Delegation, Decoupling, Business

StructuralBusinessDecouplingDelegationEnterprise patternsLayered architectureAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/business-delegate/#also-known-as)

- Service Representative

## [Intent of Business Delegate Design Pattern](https://java-design-patterns.com/patterns/business-delegate/#intent-of-business-delegate-design-pattern)
...
## [Detailed Explanation of Business Delegate Pattern with Real-World Examples](https://java-design-patterns.com/patterns/business-delegate/#detailed-explanation-of-business-delegate-pattern-with-real-world-examples)
...
![Business Delegate sequence diagram](https://java-design-patterns.com/assets/img/business-delegate-sequence-diagram.124f8ba7.png)

## [Programmatic Example of Business Delegate Pattern in Java](https://java-design-patterns.com/patterns/business-delegate/#programmatic-example-of-business-delegate-pattern-in-java)
...
## [When to Use the Business Delegate Pattern in Java](https://java-design-patterns.com/patterns/business-delegate/#when-to-use-the-business-delegate-pattern-in-java)
...
## [Business Delegate Pattern Java Tutorials](https://java-design-patterns.com/patterns/business-delegate/#business-delegate-pattern-java-tutorials)
...
## [Real-World Applications of Business Delegate Pattern in Java](https://java-design-patterns.com/patterns/business-delegate/#real-world-applications-of-business-delegate-pattern-in-java)
...
## [Benefits and Trade-offs of Business Delegate Pattern](https://java-design-patterns.com/patterns/business-delegate/#benefits-and-trade-offs-of-business-delegate-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/business-delegate/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/business-delegate/#references-and-credits)
