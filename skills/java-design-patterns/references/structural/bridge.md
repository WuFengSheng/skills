---
name: "bridge"
description: "Bridge 桥接 -- Structural设计模式。Learn about the Bridge design pattern in Java. Decouple abstraction from implementation to enhance flexibility and extensibility. Explore real-world e"
url: "https://java-design-patterns.com/patterns/bridge/"
category: "structural"
tags: [Object composition, Gang of Four, Extensibility, Decoupling, Abstraction]
---

# Bridge 桥接模式

> 官方文档: https://java-design-patterns.com/patterns/bridge/
> 分类: Structural (structural)
> 标签: Object composition, Gang of Four, Extensibility, Decoupling, Abstraction

StructuralAbstractionDecouplingExtensibilityGang of FourObject compositionAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/bridge/#also-known-as)

- Handle/Body

## [Intent of Bridge Design Pattern](https://java-design-patterns.com/patterns/bridge/#intent-of-bridge-design-pattern)
...
## [Detailed Explanation of Bridge Pattern with Real-World Examples](https://java-design-patterns.com/patterns/bridge/#detailed-explanation-of-bridge-pattern-with-real-world-examples)
...
![Bridge sequence diagram](https://java-design-patterns.com/assets/img/bridge-sequence-diagram.400ecb3b.png)

## [Programmatic Example of Bridge Pattern in Java](https://java-design-patterns.com/patterns/bridge/#programmatic-example-of-bridge-pattern-in-java)
...
## [When to Use the Bridge Pattern in Java](https://java-design-patterns.com/patterns/bridge/#when-to-use-the-bridge-pattern-in-java)
...
## [Bridge Pattern Java Tutorials](https://java-design-patterns.com/patterns/bridge/#bridge-pattern-java-tutorials)

- [Bridge Pattern Tutorial (DigitalOcean)](https://www.digitalocean.com/community/tutorials/bridge-design-pattern-java)

## [Real-World Applications of Bridge Pattern in Java](https://java-design-patterns.com/patterns/bridge/#real-world-applications-of-bridge-pattern-in-java)
...
## [Benefits and Trade-offs of Bridge Pattern](https://java-design-patterns.com/patterns/bridge/#benefits-and-trade-offs-of-bridge-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/bridge/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/bridge/#references-and-credits)
