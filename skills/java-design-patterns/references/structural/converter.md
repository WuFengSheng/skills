---
name: "converter"
description: "Converter 转换器 -- Structural设计模式。Discover the benefits and implementation of the Converter Pattern in Java. Learn how to achieve seamless bidirectional conversion between different da"
url: "https://java-design-patterns.com/patterns/converter/"
category: "structural"
tags: [Wrapping, Object mapping, Interface, Decoupling, Data transformation, Compatibility]
---

# Converter 转换器模式

> 官方文档: https://java-design-patterns.com/patterns/converter/
> 分类: Structural (structural)
> 标签: Wrapping, Object mapping, Interface, Decoupling, Data transformation, Compatibility

StructuralCompatibilityData transformationDecouplingInterfaceObject mappingWrappingAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/converter/#also-known-as)

- Mapper
- Translator

## [Intent of Converter Design Pattern](https://java-design-patterns.com/patterns/converter/#intent-of-converter-design-pattern)
...
## [Detailed Explanation of Converter Pattern with Real-World Examples](https://java-design-patterns.com/patterns/converter/#detailed-explanation-of-converter-pattern-with-real-world-examples)
...
![Converter sequence diagram](https://java-design-patterns.com/assets/img/converter-sequence-diagram.9376d20c.png)

## [Programmatic Example of Converter Pattern in Java](https://java-design-patterns.com/patterns/converter/#programmatic-example-of-converter-pattern-in-java)
...
## [When to Use the Converter Pattern in Java](https://java-design-patterns.com/patterns/converter/#when-to-use-the-converter-pattern-in-java)
...
## [Converter Pattern Java Tutorials](https://java-design-patterns.com/patterns/converter/#converter-pattern-java-tutorials)

- [Converter Pattern in Java 8 (Boldare)](http://www.xsolve.pl/blog/converter-pattern-in-java-8/)

## [Real-World Applications of Converter Pattern in Java](https://java-design-patterns.com/patterns/converter/#real-world-applications-of-converter-pattern-in-java)
...
## [Benefits and Trade-offs of Converter Pattern](https://java-design-patterns.com/patterns/converter/#benefits-and-trade-offs-of-converter-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/converter/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/converter/#references-and-credits)
