---
name: "proxy"
description: "Proxy 代理 -- Structural设计模式。Explore the Proxy design pattern in Java with detailed examples. Learn how it provides controlled access, facilitates lazy initialization, and ensures"
url: "https://java-design-patterns.com/patterns/proxy/"
category: "structural"
tags: [Wrapping, Security, Proxy, Lazy initialization, Gang of Four, Encapsulation, Decoupling]
---

# Proxy 代理模式

> 官方文档: https://java-design-patterns.com/patterns/proxy/
> 分类: Structural (structural)
> 标签: Wrapping, Security, Proxy, Lazy initialization, Gang of Four, Encapsulation, Decoupling

StructuralDecouplingEncapsulationGang of FourLazy initializationProxySecurityWrappingAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/proxy/#also-known-as)

- Surrogate

## [Intent of Proxy Design Pattern](https://java-design-patterns.com/patterns/proxy/#intent-of-proxy-design-pattern)
...
## [Detailed Explanation of Proxy Pattern with Real-World Examples](https://java-design-patterns.com/patterns/proxy/#detailed-explanation-of-proxy-pattern-with-real-world-examples)
...
![Proxy sequence diagram](https://java-design-patterns.com/assets/img/proxy-sequence-diagram.f44fe515.png)

## [Programmatic Example of Proxy Pattern in Java](https://java-design-patterns.com/patterns/proxy/#programmatic-example-of-proxy-pattern-in-java)
...
## [When to Use the Proxy Pattern in Java](https://java-design-patterns.com/patterns/proxy/#when-to-use-the-proxy-pattern-in-java)
...
## [Real-World Applications of Proxy Pattern in Java](https://java-design-patterns.com/patterns/proxy/#real-world-applications-of-proxy-pattern-in-java)
...
## [Benefits and Trade-offs of Proxy Pattern](https://java-design-patterns.com/patterns/proxy/#benefits-and-trade-offs-of-proxy-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/proxy/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/proxy/#references-and-credits)
