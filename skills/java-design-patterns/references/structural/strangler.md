---
name: "strangler"
description: "Strangler 绞杀者 -- Structural设计模式。Explore the Strangler design pattern for Java, a strategic approach to incrementally modernize legacy systems without disruption. Learn how it facilit"
url: "https://java-design-patterns.com/patterns/strangler/"
category: "structural"
tags: [Refactoring, Modernization, Migration]
---

# Strangler 绞杀者模式

> 官方文档: https://java-design-patterns.com/patterns/strangler/
> 分类: Structural (structural)
> 标签: Refactoring, Modernization, Migration

StructuralMigrationModernizationRefactoringAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/strangler/#also-known-as)

- Strangler Fig

## [Intent of Strangler Design Pattern](https://java-design-patterns.com/patterns/strangler/#intent-of-strangler-design-pattern)
...
## [Detailed Explanation of Strangler Pattern with Real-World Examples](https://java-design-patterns.com/patterns/strangler/#detailed-explanation-of-strangler-pattern-with-real-world-examples)
...
![Strangler flowchart](https://java-design-patterns.com/assets/img/strangler-flowchart.a8664fdf.png)

## [Programmatic Example of Strangler Pattern in Java](https://java-design-patterns.com/patterns/strangler/#programmatic-example-of-strangler-pattern-in-java)
...
## [When to Use the Strangler Pattern in Java](https://java-design-patterns.com/patterns/strangler/#when-to-use-the-strangler-pattern-in-java)
...
## [Strangler Pattern Java Tutorials](https://java-design-patterns.com/patterns/strangler/#strangler-pattern-java-tutorials)
...
## [Real-World Applications of Strangler Pattern in Java](https://java-design-patterns.com/patterns/strangler/#real-world-applications-of-strangler-pattern-in-java)
...
## [Benefits and Trade-offs of Strangler Pattern](https://java-design-patterns.com/patterns/strangler/#benefits-and-trade-offs-of-strangler-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/strangler/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/strangler/#references-and-credits)
