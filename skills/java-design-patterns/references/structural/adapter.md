---
name: "adapter"
description: "Adapter 适配器 -- 设计模式。Adapter 设计模式 Java 实现"
url: "https://java-design-patterns.com/patterns/adapter/"
category: "structural"
tags: []
---
...
> 官方文档: https://java-design-patterns.com/patterns/adapter/
> 分类:  (structural)


StructuralCompatibilityDecouplingGang of FourInterfaceObject compositionWrappingAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/adapter/#also-known-as)

- Wrapper

## [Intent of Adapter Design Pattern](https://java-design-patterns.com/patterns/adapter/#intent-of-adapter-design-pattern)
...
## [Detailed Explanation of Adapter Pattern with Real-World Examples](https://java-design-patterns.com/patterns/adapter/#detailed-explanation-of-adapter-pattern-with-real-world-examples)
...
![Adapter sequence diagram](https://java-design-patterns.com/assets/img/adapter-sequence-diagram.6b7d7a73.png)

## [Programmatic Example of Adapter Pattern in Java](https://java-design-patterns.com/patterns/adapter/#programmatic-example-of-adapter-pattern-in-java)
...
## [When to Use the Adapter Pattern in Java](https://java-design-patterns.com/patterns/adapter/#when-to-use-the-adapter-pattern-in-java)
...
## [Adapter Pattern Java Tutorials](https://java-design-patterns.com/patterns/adapter/#adapter-pattern-java-tutorials)
...
## [Benefits and Trade-offs of Adapter Pattern](https://java-design-patterns.com/patterns/adapter/#benefits-and-trade-offs-of-adapter-pattern)
...
## [Real-World Applications of Adapter Pattern in Java](https://java-design-patterns.com/patterns/adapter/#real-world-applications-of-adapter-pattern-in-java)
...
## [References and Credits](https://java-design-patterns.com/patterns/adapter/#references-and-credits)
