...
description: "Curiously Recurring Template CRTP -- Structural设计模式。Discover the Curiously Recurring Template Pattern (CRTP) in Java. Learn how to achieve static polymorphism for efficient method overriding and compile"
url: "https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/"
category: "structural"
tags: [Recursion, Polymorphism, Instantiation, Idiom, Generic, Extensibility, Code simplification]
---

# Curiously Recurring Template CRTP模式

> 官方文档: https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/
> 分类: Structural (structural)
> 标签: Recursion, Polymorphism, Instantiation, Idiom, Generic, Extensibility, Code simplification

StructuralCode simplificationExtensibilityGenericIdiomInstantiationPolymorphismRecursionAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#also-known-as)
...
## [Intent of Curiously Recurring Template Pattern](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#intent-of-curiously-recurring-template-pattern)
...
## [Detailed Explanation of Curiously Recurring Template Pattern with Real-World Examples](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#detailed-explanation-of-curiously-recurring-template-pattern-with-real-world-examples)
...
![Curiously Recurring Template Pattern flowchart](https://java-design-patterns.com/assets/img/crtp-flowchart.7b46473e.png)

## [Programmatic example of CRTP in Java](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#programmatic-example-of-crtp-in-java)
...
## [When to Use the Curiously Recurring Template Pattern in Java](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#when-to-use-the-curiously-recurring-template-pattern-in-java)
...
## [Curiously Recurring Template Pattern Java Tutorials](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#curiously-recurring-template-pattern-java-tutorials)

- [Curiously Recurring Template Pattern in Java (The NuaH Blog)](https://nuah.livejournal.com/328187.html)

## [Real-World Applications of Curiously Recurring Template Pattern in Java](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#real-world-applications-of-curiously-recurring-template-pattern-in-java)
...
## [Benefits and Trade-offs of Curiously Recurring Template Pattern](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#benefits-and-trade-offs-of-curiously-recurring-template-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/curiously-recurring-template-pattern/#references-and-credits)
