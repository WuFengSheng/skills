---
name: "decorator"
description: "Decorator 装饰器 -- Structural设计模式。Learn how the Decorator Design Pattern enhances flexibility in Java programming by allowing dynamic addition of responsibilities to objects without mo"
url: "https://java-design-patterns.com/patterns/decorator/"
category: "structural"
tags: [Wrapping, Object composition, Gang of Four, Extensibility, Enhancement]
---

# Decorator 装饰器模式

> 官方文档: https://java-design-patterns.com/patterns/decorator/
> 分类: Structural (structural)
> 标签: Wrapping, Object composition, Gang of Four, Extensibility, Enhancement

StructuralEnhancementExtensibilityGang of FourObject compositionWrappingAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/decorator/#also-known-as)

- Smart Proxy
- Wrapper

## [Intent of Decorator Design Pattern](https://java-design-patterns.com/patterns/decorator/#intent-of-decorator-design-pattern)
...
## [Detailed Explanation of Decorator Pattern with Real-World Examples](https://java-design-patterns.com/patterns/decorator/#detailed-explanation-of-decorator-pattern-with-real-world-examples)
...
![Decorator sequence diagram](https://java-design-patterns.com/assets/img/decorator-sequence-diagram.dd3d2eef.png)

## [Programmatic Example of Decorator Pattern in Java](https://java-design-patterns.com/patterns/decorator/#programmatic-example-of-decorator-pattern-in-java)
...
## [When to Use the Decorator Pattern in Java](https://java-design-patterns.com/patterns/decorator/#when-to-use-the-decorator-pattern-in-java)
...
## [Decorator Pattern Java Tutorials](https://java-design-patterns.com/patterns/decorator/#decorator-pattern-java-tutorials)
...
## [Real-World Applications of Decorator Pattern in Java](https://java-design-patterns.com/patterns/decorator/#real-world-applications-of-decorator-pattern-in-java)
...
## [Benefits and Trade-offs of Decorator Pattern](https://java-design-patterns.com/patterns/decorator/#benefits-and-trade-offs-of-decorator-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/decorator/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/decorator/#references-and-credits)
