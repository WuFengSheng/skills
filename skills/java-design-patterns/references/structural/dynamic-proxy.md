---
name: "dynamic-proxy"
description: "Dynamic Proxy 动态代理 -- Structural设计模式。Explore the Dynamic Proxy Pattern in Java, a flexible runtime mechanism for creating proxies that enhance functionality and control access to objects."
url: "https://java-design-patterns.com/patterns/dynamic-proxy/"
category: "structural"
tags: [Runtime, Proxy, Extensibility, Enhancement, Dynamic typing, Decoupling]
---

# Dynamic Proxy 动态代理模式

> 官方文档: https://java-design-patterns.com/patterns/dynamic-proxy/
> 分类: Structural (structural)
> 标签: Runtime, Proxy, Extensibility, Enhancement, Dynamic typing, Decoupling

StructuralDecouplingDynamic typingEnhancementExtensibilityProxyRuntimeAbout 12 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/dynamic-proxy/#also-known-as)

- Runtime Proxy

## [Intent of Dynamic Proxy Design Pattern](https://java-design-patterns.com/patterns/dynamic-proxy/#intent-of-dynamic-proxy-design-pattern)
...
## [Detailed Explanation of Dynamic Proxy Pattern with Real-World Examples](https://java-design-patterns.com/patterns/dynamic-proxy/#detailed-explanation-of-dynamic-proxy-pattern-with-real-world-examples)
...
![Dynamic Proxy sequence diagram](https://java-design-patterns.com/assets/img/dynamic-proxy-sequence-diagram.0cc06470.png)

## [Programmatic Example of Dynamic Proxy Pattern in Java](https://java-design-patterns.com/patterns/dynamic-proxy/#programmatic-example-of-dynamic-proxy-pattern-in-java)
...
## [When to Use the Dynamic Proxy Pattern in Java](https://java-design-patterns.com/patterns/dynamic-proxy/#when-to-use-the-dynamic-proxy-pattern-in-java)
...
## [Dynamic Proxy Pattern Java Tutorials](https://java-design-patterns.com/patterns/dynamic-proxy/#dynamic-proxy-pattern-java-tutorials)
...
## [Real-World Applications of Dynamic Proxy Pattern in Java](https://java-design-patterns.com/patterns/dynamic-proxy/#real-world-applications-of-dynamic-proxy-pattern-in-java)
...
## [Benefits and Trade-offs of Dynamic Proxy Pattern](https://java-design-patterns.com/patterns/dynamic-proxy/#benefits-and-trade-offs-of-dynamic-proxy-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/dynamic-proxy/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/dynamic-proxy/#references-and-credits)
