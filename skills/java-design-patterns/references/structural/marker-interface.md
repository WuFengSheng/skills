...
description: "Marker Interface 标记接口 -- Structural设计模式。Explore the Marker Interface pattern in Java, its benefits, real-world examples, and common uses. Learn how to use marker interfaces for metadata and "
url: "https://java-design-patterns.com/patterns/marker-interface/"
category: "structural"
tags: [Polymorphism, Interface, Encapsulation]
---

# Marker Interface 标记接口模式

> 官方文档: https://java-design-patterns.com/patterns/marker-interface/
> 分类: Structural (structural)
> 标签: Polymorphism, Interface, Encapsulation

StructuralEncapsulationInterfacePolymorphismAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/marker-interface/#also-known-as)

- Marker
- Tagging Interface

## [Intent of Marker Interface Design Pattern](https://java-design-patterns.com/patterns/marker-interface/#intent-of-marker-interface-design-pattern)
...
## [Detailed Explanation of Marker Interface Pattern with Real-World Examples](https://java-design-patterns.com/patterns/marker-interface/#detailed-explanation-of-marker-interface-pattern-with-real-world-examples)
...
![Marker Interface flowchart](https://java-design-patterns.com/assets/img/marker-interface-flowchart.68343009.png)

## [Programmatic Example of Marker Interface Pattern in Java](https://java-design-patterns.com/patterns/marker-interface/#programmatic-example-of-marker-interface-pattern-in-java)
...
## [When to Use the Marker Interface Pattern in Java](https://java-design-patterns.com/patterns/marker-interface/#when-to-use-the-marker-interface-pattern-in-java)
...
## [Real-World Applications of Marker Interface Pattern in Java](https://java-design-patterns.com/patterns/marker-interface/#real-world-applications-of-marker-interface-pattern-in-java)
...
## [Benefits and Trade-offs of Marker Interface Pattern](https://java-design-patterns.com/patterns/marker-interface/#benefits-and-trade-offs-of-marker-interface-pattern)
...
## [References and Credits](https://java-design-patterns.com/patterns/marker-interface/#references-and-credits)
