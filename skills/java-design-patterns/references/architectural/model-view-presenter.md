...
description: "Model-View-Presenter MVP -- Architectural设计模式。Discover the Model-View-Presenter (MVP) pattern in Java. Learn how it separates user interface, business logic, and data interaction to enhance testab"
url: "https://java-design-patterns.com/patterns/model-view-presenter/"
category: "architectural"
tags: [Presentation, Interface, Enterprise patterns, Decoupling, Client-server, Architecture]
---

# Model-View-Presenter MVP模式

> 官方文档: https://java-design-patterns.com/patterns/model-view-presenter/
> 分类: Architectural (architectural)
> 标签: Presentation, Interface, Enterprise patterns, Decoupling, Client-server, Architecture

ArchitecturalArchitectureClient-serverDecouplingEnterprise patternsInterfacePresentationAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/model-view-presenter/#also-known-as)

- MVP

## [Intent of Model-View-Presenter Design Pattern](https://java-design-patterns.com/patterns/model-view-presenter/#intent-of-model-view-presenter-design-pattern)
...
## [Detailed Explanation of Model-View-Presenter Pattern with Real-World Examples](https://java-design-patterns.com/patterns/model-view-presenter/#detailed-explanation-of-model-view-presenter-pattern-with-real-world-examples)
...
![Model-View-Presenter Architecture Diagram](https://java-design-patterns.com/assets/img/mvp-architecture-diagram.bd626c5d.png)

## [Programmatic Example of Model-View-Presenter Pattern in Java](https://java-design-patterns.com/patterns/model-view-presenter/#programmatic-example-of-model-view-presenter-pattern-in-java)
...
## [When to Use the Model-View-Presenter Pattern in Java](https://java-design-patterns.com/patterns/model-view-presenter/#when-to-use-the-model-view-presenter-pattern-in-java)
...
## [Real-World Applications of Model-View-Presenter Pattern in Java](https://java-design-patterns.com/patterns/model-view-presenter/#real-world-applications-of-model-view-presenter-pattern-in-java)
...
## [Benefits and Trade-offs of Model-View-Presenter Pattern](https://java-design-patterns.com/patterns/model-view-presenter/#benefits-and-trade-offs-of-model-view-presenter-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/model-view-presenter/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/model-view-presenter/#references-and-credits)
