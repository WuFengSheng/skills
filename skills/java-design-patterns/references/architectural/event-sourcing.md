---
name: "event-sourcing"
description: "Event Sourcing 事件溯源 -- Architectural设计模式。Discover the Event Sourcing design pattern in Java. Learn how it stores state changes as events and benefits complex applications. See examples and ex"
url: "https://java-design-patterns.com/patterns/event-sourcing/"
category: "architectural"
tags: [Transactions, Scalability, Persistence, Messaging, Fault tolerance, Event-driven, Decoupling]
---

# Event Sourcing 事件溯源模式

> 官方文档: https://java-design-patterns.com/patterns/event-sourcing/
> 分类: Architectural (architectural)
> 标签: Transactions, Scalability, Persistence, Messaging, Fault tolerance, Event-driven, Decoupling

ArchitecturalDecouplingEvent-drivenFault toleranceMessagingPersistenceScalabilityTransactionsAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/event-sourcing/#also-known-as)

- Event Logging
- Event Streaming

## [Intent of Event Sourcing Design Pattern](https://java-design-patterns.com/patterns/event-sourcing/#intent-of-event-sourcing-design-pattern)
...
## [Detailed Explanation of Event Sourcing Pattern with Real-World Examples](https://java-design-patterns.com/patterns/event-sourcing/#detailed-explanation-of-event-sourcing-pattern-with-real-world-examples)
...
![Event Sourcing Architecture Diagram](https://java-design-patterns.com/assets/img/event-sourcing-architecture-diagram.e1de9c3e.png)

## [Programmatic Example of Event Sourcing Pattern in Java](https://java-design-patterns.com/patterns/event-sourcing/#programmatic-example-of-event-sourcing-pattern-in-java)
...
## [When to Use the Event Sourcing Pattern in Java](https://java-design-patterns.com/patterns/event-sourcing/#when-to-use-the-event-sourcing-pattern-in-java)
...
## [Real-World Applications of Event Sourcing Pattern in Java](https://java-design-patterns.com/patterns/event-sourcing/#real-world-applications-of-event-sourcing-pattern-in-java)
...
## [Benefits and Trade-offs of Event Sourcing Pattern](https://java-design-patterns.com/patterns/event-sourcing/#benefits-and-trade-offs-of-event-sourcing-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/event-sourcing/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/event-sourcing/#references-and-credits)
