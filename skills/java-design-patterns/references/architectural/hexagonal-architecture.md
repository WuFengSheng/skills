...
description: "Hexagonal Architecture 六边形架构 -- Architectural设计模式。Explore the Hexagonal Architecture pattern in Java. Learn how it decouples core logic from external interfaces, enhances maintainability, and improves"
url: "https://java-design-patterns.com/patterns/hexagonal-architecture/"
category: "architectural"
tags: [Layered architecture, Decoupling]
---

# Hexagonal Architecture 六边形架构模式

> 官方文档: https://java-design-patterns.com/patterns/hexagonal-architecture/
> 分类: Architectural (architectural)
> 标签: Layered architecture, Decoupling

ArchitecturalDecouplingLayered architectureAbout 6 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/hexagonal-architecture/#also-known-as)

- Ports and Adapters

## [Intent of Hexagonal Architecture Design Pattern](https://java-design-patterns.com/patterns/hexagonal-architecture/#intent-of-hexagonal-architecture-design-pattern)
...
## [Detailed Explanation of Hexagonal Architecture Pattern with Real-World Examples](https://java-design-patterns.com/patterns/hexagonal-architecture/#detailed-explanation-of-hexagonal-architecture-pattern-with-real-world-examples)
...
![Hexagonal Architecture Diagram](https://java-design-patterns.com/assets/img/hexagonal-architecture-diagram.057a8c09.png)

## [Programmatic Example of Hexagonal Architecture Pattern in Java](https://java-design-patterns.com/patterns/hexagonal-architecture/#programmatic-example-of-hexagonal-architecture-pattern-in-java)
...
## [When to Use the Hexagonal Architecture Pattern in Java](https://java-design-patterns.com/patterns/hexagonal-architecture/#when-to-use-the-hexagonal-architecture-pattern-in-java)
...
## [Real-World Applications of Hexagonal Architecture Pattern in Java](https://java-design-patterns.com/patterns/hexagonal-architecture/#real-world-applications-of-hexagonal-architecture-pattern-in-java)
...
## [Benefits and Trade-offs of Hexagonal Architecture Pattern](https://java-design-patterns.com/patterns/hexagonal-architecture/#benefits-and-trade-offs-of-hexagonal-architecture-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/hexagonal-architecture/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/hexagonal-architecture/#references-and-credits)
