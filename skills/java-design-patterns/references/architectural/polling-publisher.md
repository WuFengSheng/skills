...
description: "Polling Publisher-Subscriber 轮询发布订阅 -- Architectural设计模式。Learn how to implement a Polling Publisher-Subscriber system in Java using Spring Boot and Kafka. Explore the architecture, real-world analogies, and "
url: "https://java-design-patterns.com/patterns/polling-publisher/"
category: "architectural"
tags: [Decoupling, Asynchronous Messaging, Microservices, Kafka, Spring Boot]
---

# Polling Publisher-Subscriber 轮询发布订阅模式

> 官方文档: https://java-design-patterns.com/patterns/polling-publisher/
> 分类: Architectural (architectural)
> 标签: Decoupling, Asynchronous Messaging, Microservices, Kafka, Spring Boot
