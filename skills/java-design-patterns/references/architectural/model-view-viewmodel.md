...
description: "Model-View-ViewModel MVVM -- Architectural设计模式。Learn about the Model-View-ViewModel (MVVM) design pattern in Java. Discover its benefits, real-world applications, and how it improves UI and busines"
url: "https://java-design-patterns.com/patterns/model-view-viewmodel/"
category: "architectural"
tags: [Scalability, Presentation, Decoupling, Data binding, Architecture]
---

# Model-View-ViewModel MVVM模式

> 官方文档: https://java-design-patterns.com/patterns/model-view-viewmodel/
> 分类: Architectural (architectural)
> 标签: Scalability, Presentation, Decoupling, Data binding, Architecture

ArchitecturalArchitectureData bindingDecouplingPresentationScalabilityAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/model-view-viewmodel/#also-known-as)

- MVVM

## [Intent of Model-View-ViewModel Design Pattern](https://java-design-patterns.com/patterns/model-view-viewmodel/#intent-of-model-view-viewmodel-design-pattern)
...
## [Detailed Explanation of Model-View-ViewModel Pattern with Real-World Examples](https://java-design-patterns.com/patterns/model-view-viewmodel/#detailed-explanation-of-model-view-viewmodel-pattern-with-real-world-examples)
...
![Model-View-ViewModel Architecture Diagram](https://java-design-patterns.com/assets/img/mvvm-architecture-diagram.6026b955.png)

## [Programmatic Example of Model-View-ViewModel Pattern in Java](https://java-design-patterns.com/patterns/model-view-viewmodel/#programmatic-example-of-model-view-viewmodel-pattern-in-java)
...
- Open browser to address: [http://localhost:9911/model-view-viewmodel/](http://localhost:9911/model-view-viewmodel/)

## [When to Use the Model-View-ViewModel Pattern in Java](https://java-design-patterns.com/patterns/model-view-viewmodel/#when-to-use-the-model-view-viewmodel-pattern-in-java)
...
## [Model-View-ViewModel Pattern Java Tutorials](https://java-design-patterns.com/patterns/model-view-viewmodel/#model-view-viewmodel-pattern-java-tutorials)
...
## [Real-World Applications of Model-View-ViewModel Pattern in Java](https://java-design-patterns.com/patterns/model-view-viewmodel/#real-world-applications-of-model-view-viewmodel-pattern-in-java)
...
## [Benefits and Trade-offs of Model-View-ViewModel Pattern](https://java-design-patterns.com/patterns/model-view-viewmodel/#benefits-and-trade-offs-of-model-view-viewmodel-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/model-view-viewmodel/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/model-view-viewmodel/#references-and-credits)
