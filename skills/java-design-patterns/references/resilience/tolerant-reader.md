...
description: "Tolerant Reader 宽容读取器 -- Resilience设计模式。Discover how the Tolerant Reader pattern can boost your API's resilience by ignoring unrecognized data, ensuring backward compatibility and seamless i"
url: "https://java-design-patterns.com/patterns/tolerant-reader/"
category: "resilience"
tags: [Integration, Fault tolerance, Decoupling, API design]
---

# Tolerant Reader 宽容读取器模式

> 官方文档: https://java-design-patterns.com/patterns/tolerant-reader/
> 分类: Resilience (resilience)
> 标签: Integration, Fault tolerance, Decoupling, API design

ResilienceAPI designDecouplingFault toleranceIntegrationAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/tolerant-reader/#also-known-as)

- Lenient Consumer

## [Intent of Tolerant Reader Design Pattern](https://java-design-patterns.com/patterns/tolerant-reader/#intent-of-tolerant-reader-design-pattern)
...
## [Detailed Explanation of Tolerant Reader Pattern with Real-World Examples](https://java-design-patterns.com/patterns/tolerant-reader/#detailed-explanation-of-tolerant-reader-pattern-with-real-world-examples)
...
![Tolerant Reader sequence diagrams](https://java-design-patterns.com/assets/img/tolerant-reader-sequence-diagram.a0de01ab.png)

## [Programmatic Example of Tolerant Reader Pattern in Java](https://java-design-patterns.com/patterns/tolerant-reader/#programmatic-example-of-tolerant-reader-pattern-in-java)
...
## [When to Use the Tolerant Reader Pattern in Java](https://java-design-patterns.com/patterns/tolerant-reader/#when-to-use-the-tolerant-reader-pattern-in-java)
...
## [Real-World Applications of Tolerant Reader Pattern in Java](https://java-design-patterns.com/patterns/tolerant-reader/#real-world-applications-of-tolerant-reader-pattern-in-java)
...
## [Benefits and Trade-offs of Tolerant Reader Pattern](https://java-design-patterns.com/patterns/tolerant-reader/#benefits-and-trade-offs-of-tolerant-reader-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/tolerant-reader/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/tolerant-reader/#references-and-credits)
