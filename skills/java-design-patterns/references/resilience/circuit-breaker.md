...
description: "Circuit Breaker 断路器 -- Resilience设计模式。Learn about the Circuit Breaker pattern in Java design, which ensures fault tolerance and prevents cascading failures in distributed systems and micro"
url: "https://java-design-patterns.com/patterns/circuit-breaker/"
category: "resilience"
tags: [Retry, Microservices, Fault tolerance, Cloud distributed]
---

# Circuit Breaker 断路器模式

> 官方文档: https://java-design-patterns.com/patterns/circuit-breaker/
> 分类: Resilience (resilience)
> 标签: Retry, Microservices, Fault tolerance, Cloud distributed

ResilienceCloud distributedFault toleranceMicroservicesRetryAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/circuit-breaker/#also-known-as)

- Fault Tolerance Switch

## [Intent of Circuit Breaker Design Pattern](https://java-design-patterns.com/patterns/circuit-breaker/#intent-of-circuit-breaker-design-pattern)
...
## [Detailed Explanation of Circuit Breaker Pattern with Real-World Examples](https://java-design-patterns.com/patterns/circuit-breaker/#detailed-explanation-of-circuit-breaker-pattern-with-real-world-examples)
...
![Circuit Breaker flowchart](https://java-design-patterns.com/assets/img/circuit-breaker-flowchart.34a2cf13.png)

## [Programmatic Example of Circuit Breaker Pattern in Java](https://java-design-patterns.com/patterns/circuit-breaker/#programmatic-example-of-circuit-breaker-pattern-in-java)
...
## [When to Use the Circuit Breaker Pattern in Java](https://java-design-patterns.com/patterns/circuit-breaker/#when-to-use-the-circuit-breaker-pattern-in-java)
...
## [Real-World Applications of Circuit Breaker Pattern in Java](https://java-design-patterns.com/patterns/circuit-breaker/#real-world-applications-of-circuit-breaker-pattern-in-java)
...
## [Benefits and Trade-offs of Circuit Breaker Pattern](https://java-design-patterns.com/patterns/circuit-breaker/#benefits-and-trade-offs-of-circuit-breaker-pattern)
...
## [Related Patterns](https://java-design-patterns.com/patterns/circuit-breaker/#related-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/circuit-breaker/#references-and-credits)
