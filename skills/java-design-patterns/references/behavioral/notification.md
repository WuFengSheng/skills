---
name: "notification"
description: "Notification 通知 -- Behavioral设计模式。Learn how to implement the Notification design pattern in Java with detailed explanations, code examples, and use cases. Improve your design patterns "
url: "https://java-design-patterns.com/patterns/notification/"
category: "behavioral"
tags: [Publish/subscribe, Messaging, Event-driven, Decoupling, Asynchronous]
---

# Notification 通知模式

> 官方文档: https://java-design-patterns.com/patterns/notification/
> 分类: Behavioral (behavioral)
> 标签: Publish/subscribe, Messaging, Event-driven, Decoupling, Asynchronous

BehavioralAsynchronousDecouplingEvent-drivenMessagingPublish/subscribeAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/notification/#also-known-as)

- Event Listener

## [Intent of Notification Design Pattern](https://java-design-patterns.com/patterns/notification/#intent-of-notification-design-pattern)
...
## [Detailed Explanation of Notification Pattern with Real-World Examples](https://java-design-patterns.com/patterns/notification/#detailed-explanation-of-notification-pattern-with-real-world-examples)
...
![Notification sequence diagram](https://java-design-patterns.com/assets/img/notification-sequence-diagram.efe9bae6.png)

## [Programmatic Example of Notification Pattern in Java](https://java-design-patterns.com/patterns/notification/#programmatic-example-of-notification-pattern-in-java)
...
## [When to Use the Notification Pattern in Java](https://java-design-patterns.com/patterns/notification/#when-to-use-the-notification-pattern-in-java)
...
## [Real-World Applications of Notification Pattern in Java](https://java-design-patterns.com/patterns/notification/#real-world-applications-of-notification-pattern-in-java)
...
## [Benefits and Trade-offs of Notification Pattern](https://java-design-patterns.com/patterns/notification/#benefits-and-trade-offs-of-notification-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/notification/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/notification/#references-and-credits)
