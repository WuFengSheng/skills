---
name: "state"
description: "State 状态 -- Behavioral设计模式。Explore the State Pattern, a core component of Java design patterns that enables dynamic behavior change in objects with internal state shifts. Includ"
url: "https://java-design-patterns.com/patterns/state/"
category: "behavioral"
tags: [State tracking, Gang of Four, Decoupling]
---

# State 状态模式

> 官方文档: https://java-design-patterns.com/patterns/state/
> 分类: Behavioral (behavioral)
> 标签: State tracking, Gang of Four, Decoupling

BehavioralDecouplingGang of FourState trackingAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/state/#also-known-as)

- Objects for States

## [Intent of State Design Pattern](https://java-design-patterns.com/patterns/state/#intent-of-state-design-pattern)
...
## [Detailed Explanation of State Pattern with Real-World Examples](https://java-design-patterns.com/patterns/state/#detailed-explanation-of-state-pattern-with-real-world-examples)
...
![State flowchart](https://java-design-patterns.com/assets/img/state-flowchart.099ecdf6.png)

## [Programmatic Example of State Pattern in Java](https://java-design-patterns.com/patterns/state/#programmatic-example-of-state-pattern-in-java)
...
## [When to Use the State Pattern in Java](https://java-design-patterns.com/patterns/state/#when-to-use-the-state-pattern-in-java)

- An object's behavior depends on its state, and it must change its behavior at runtime depending on that state.
- Operations have large, multipart conditional statements that depend on the object's state.

## [Real-World Applications of State Pattern in Java](https://java-design-patterns.com/patterns/state/#real-world-applications-of-state-pattern-in-java)
...
## [Benefits and Trade-offs of State Pattern](https://java-design-patterns.com/patterns/state/#benefits-and-trade-offs-of-state-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/state/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/state/#references-and-credits)
