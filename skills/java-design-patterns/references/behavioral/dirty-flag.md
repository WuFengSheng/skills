---
name: "dirty-flag"
description: "Dirty Flag 脏标记 -- Behavioral设计模式。Learn about the Dirty Flag design pattern in Java for efficient state tracking and resource management. Avoid unnecessary computations with practical "
url: "https://java-design-patterns.com/patterns/dirty-flag/"
category: "behavioral"
tags: [State tracking, Resource management, Performance, Game programming]
---

# Dirty Flag 脏标记模式

> 官方文档: https://java-design-patterns.com/patterns/dirty-flag/
> 分类: Behavioral (behavioral)
> 标签: State tracking, Resource management, Performance, Game programming

BehavioralGame programmingPerformanceResource managementState trackingAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/dirty-flag/#also-known-as)

- Change Tracking
- Is-Modified Flag

## [Intent of Dirty Flag Design Pattern](https://java-design-patterns.com/patterns/dirty-flag/#intent-of-dirty-flag-design-pattern)
...
## [Detailed Explanation of Dirty Flag Pattern with Real-World Examples](https://java-design-patterns.com/patterns/dirty-flag/#detailed-explanation-of-dirty-flag-pattern-with-real-world-examples)
...
![Dirty Flag flowchart](https://java-design-patterns.com/assets/img/dirty-flag-flowchart.d0ae61d6.png)

## [Programmatic Example of Dirty Flag Pattern in Java](https://java-design-patterns.com/patterns/dirty-flag/#programmatic-example-of-dirty-flag-pattern-in-java)
...
## [When to Use the Dirty Flag Pattern in Java](https://java-design-patterns.com/patterns/dirty-flag/#when-to-use-the-dirty-flag-pattern-in-java)
...
## [Dirty Flag Pattern Java Tutorials](https://java-design-patterns.com/patterns/dirty-flag/#dirty-flag-pattern-java-tutorials)

- [89: Design Patterns: Dirty Flag (TakeUpCode)](https://www.takeupcode.com/podcast/89-design-patterns-dirty-flag/)

## [Real-World Applications of Dirty Flag Pattern in Java](https://java-design-patterns.com/patterns/dirty-flag/#real-world-applications-of-dirty-flag-pattern-in-java)
...
## [Benefits and Trade-offs of Dirty Flag Pattern](https://java-design-patterns.com/patterns/dirty-flag/#benefits-and-trade-offs-of-dirty-flag-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/dirty-flag/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/dirty-flag/#references-and-credits)
