...
description: "Collecting Parameter 收集参数 -- Behavioral设计模式。Discover how the Collecting Parameter design pattern simplifies Java method calls by aggregating multiple parameters into a single collection object. "
url: "https://java-design-patterns.com/patterns/collecting-parameter/"
category: "behavioral"
tags: [Generic, Data transfer, Data processing, Accumulation]
---

# Collecting Parameter 收集参数模式

> 官方文档: https://java-design-patterns.com/patterns/collecting-parameter/
> 分类: Behavioral (behavioral)
> 标签: Generic, Data transfer, Data processing, Accumulation

BehavioralAccumulationData processingData transferGenericAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/collecting-parameter/#also-known-as)

- Collector
- Accumulator

## [Intent of Collecting Parameter Design Pattern](https://java-design-patterns.com/patterns/collecting-parameter/#intent-of-collecting-parameter-design-pattern)
...
## [Detailed Explanation of Collecting Parameter Pattern with Real-World Examples](https://java-design-patterns.com/patterns/collecting-parameter/#detailed-explanation-of-collecting-parameter-pattern-with-real-world-examples)
...
![Collecting Parameter flowchart](https://java-design-patterns.com/assets/img/collecting-parameter-flowchart.80b727ae.png)

## [Programmatic Example of Collecting Parameter Pattern in Java](https://java-design-patterns.com/patterns/collecting-parameter/#programmatic-example-of-collecting-parameter-pattern-in-java)
...
## [When to Use the Collecting Parameter Pattern in Java](https://java-design-patterns.com/patterns/collecting-parameter/#when-to-use-the-collecting-parameter-pattern-in-java)
...
## [Collecting Parameter Pattern Java Tutorials](https://java-design-patterns.com/patterns/collecting-parameter/#collecting-parameter-pattern-java-tutorials)
...
## [Real-World Applications of Collecting Parameter Pattern in Java](https://java-design-patterns.com/patterns/collecting-parameter/#real-world-applications-of-collecting-parameter-pattern-in-java)

- Use when a method needs to accept a large number of parameters, making the method signature unwieldy.
- Use when the same group of parameters is passed to multiple methods, reducing redundancy and potential errors.
- Use to improve the readability and maintainability of the code.

## [Benefits and Trade-offs of Collecting Parameter Pattern](https://java-design-patterns.com/patterns/collecting-parameter/#benefits-and-trade-offs-of-collecting-parameter-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/collecting-parameter/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/collecting-parameter/#references-and-credits)
