---
name: "iterator"
description: "Iterator 迭代器 -- Behavioral设计模式。Learn how to implement the Iterator Design Pattern in Java. Access elements of a collection sequentially without exposing its underlying structure. Ex"
url: "https://java-design-patterns.com/patterns/iterator/"
category: "behavioral"
tags: [Polymorphism, Object composition, Gang of Four, Decoupling, Data transformation, Data access]
---

# Iterator 迭代器模式

> 官方文档: https://java-design-patterns.com/patterns/iterator/
> 分类: Behavioral (behavioral)
> 标签: Polymorphism, Object composition, Gang of Four, Decoupling, Data transformation, Data access

BehavioralData accessData transformationDecouplingGang of FourObject compositionPolymorphismAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/iterator/#also-known-as)

- Cursor

## [Intent of Iterator Design Pattern](https://java-design-patterns.com/patterns/iterator/#intent-of-iterator-design-pattern)
...
## [Detailed Explanation of Iterator Pattern with Real-World Examples](https://java-design-patterns.com/patterns/iterator/#detailed-explanation-of-iterator-pattern-with-real-world-examples)
...
![Iterator sequence diagram](https://java-design-patterns.com/assets/img/iterator-sequence-diagram.c040c529.png)

## [Programmatic Example of Iterator Pattern in Java](https://java-design-patterns.com/patterns/iterator/#programmatic-example-of-iterator-pattern-in-java)
...
## [When to Use the Iterator Pattern in Java](https://java-design-patterns.com/patterns/iterator/#when-to-use-the-iterator-pattern-in-java)
...
## [Iterator Pattern Java Tutorials](https://java-design-patterns.com/patterns/iterator/#iterator-pattern-java-tutorials)

- [Java - How to Use Iterator? (TutorialsPoint)](http://www.tutorialspoint.com/java/java_using_iterator.htm)

## [Real-World Applications of Iterator Pattern in Java](https://java-design-patterns.com/patterns/iterator/#real-world-applications-of-iterator-pattern-in-java)
...
## [Benefits and Trade-offs of Iterator Pattern](https://java-design-patterns.com/patterns/iterator/#benefits-and-trade-offs-of-iterator-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/iterator/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/iterator/#references-and-credits)
