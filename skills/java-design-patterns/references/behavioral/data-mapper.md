---
name: "data-mapper"
description: "Data Mapper 数据映射器 -- Behavioral设计模式。Explore the Data Mapper pattern in Java, which decouples database operations from business logic. Learn how to implement and utilize this pattern to e"
url: "https://java-design-patterns.com/patterns/data-mapper/"
category: "behavioral"
tags: [Persistence, Object mapping, Domain, Decoupling, Data access]
---

# Data Mapper 数据映射器模式

> 官方文档: https://java-design-patterns.com/patterns/data-mapper/
> 分类: Behavioral (behavioral)
> 标签: Persistence, Object mapping, Domain, Decoupling, Data access

BehavioralData accessDecouplingDomainObject mappingPersistenceAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/data-mapper/#also-known-as)

- Object-Relational Mapping (ORM)

## [Intent of the Data Mapper Pattern](https://java-design-patterns.com/patterns/data-mapper/#intent-of-the-data-mapper-pattern)
...
## [Detailed Explanation of Data Mapper Pattern with Real-World Examples](https://java-design-patterns.com/patterns/data-mapper/#detailed-explanation-of-data-mapper-pattern-with-real-world-examples)
...
![Data Mapper sequence diagram](https://java-design-patterns.com/assets/img/data-mapper-sequence-diagram.3bcc93d0.png)

## [Programmatic Example of Data Mapper Pattern in Java](https://java-design-patterns.com/patterns/data-mapper/#programmatic-example-of-data-mapper-pattern-in-java)
...
## [When to Use the Data Mapper Pattern in Java](https://java-design-patterns.com/patterns/data-mapper/#when-to-use-the-data-mapper-pattern-in-java)
...
## [Data Mapper Pattern Java Tutorials](https://java-design-patterns.com/patterns/data-mapper/#data-mapper-pattern-java-tutorials)
...
## [Real-World Applications of Data Mapper Pattern in Java](https://java-design-patterns.com/patterns/data-mapper/#real-world-applications-of-data-mapper-pattern-in-java)
...
## [Benefits and Trade-offs of Data Mapper Pattern](https://java-design-patterns.com/patterns/data-mapper/#benefits-and-trade-offs-of-data-mapper-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/data-mapper/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/data-mapper/#references-and-credits)
