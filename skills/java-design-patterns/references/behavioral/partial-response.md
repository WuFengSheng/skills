...
description: "Partial Response 部分响应 -- Behavioral设计模式。Explore the Partial Response design pattern for APIs, a strategy to boost performance by allowing clients to process data as soon as it becomes availa"
url: "https://java-design-patterns.com/patterns/partial-response/"
category: "behavioral"
tags: [Web development, Scalability, Performance, Decoupling, Client-server, Asynchronous, API design]
---

# Partial Response 部分响应模式

> 官方文档: https://java-design-patterns.com/patterns/partial-response/
> 分类: Behavioral (behavioral)
> 标签: Web development, Scalability, Performance, Decoupling, Client-server, Asynchronous, API design

BehavioralAPI designAsynchronousClient-serverDecouplingPerformanceScalabilityWeb developmentAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/partial-response/#also-known-as)

- Incremental Response
- Partial Result

## [Intent of Partial Response Design Pattern](https://java-design-patterns.com/patterns/partial-response/#intent-of-partial-response-design-pattern)
...
## [Detailed Explanation of Partial Response Pattern with Real-World Examples](https://java-design-patterns.com/patterns/partial-response/#detailed-explanation-of-partial-response-pattern-with-real-world-examples)
...
![Partial Response sequence diagram](https://java-design-patterns.com/assets/img/partial-response-sequence-diagram.1b827648.png)

## [Programmatic Example of Partial Response Pattern in Java](https://java-design-patterns.com/patterns/partial-response/#programmatic-example-of-partial-response-pattern-in-java)
...
## [When to Use the Partial Response Pattern in Java](https://java-design-patterns.com/patterns/partial-response/#when-to-use-the-partial-response-pattern-in-java)
...
## [Real-World Applications of Partial Response Pattern in Java](https://java-design-patterns.com/patterns/partial-response/#real-world-applications-of-partial-response-pattern-in-java)
...
## [Benefits and Trade-offs of Partial Response Pattern](https://java-design-patterns.com/patterns/partial-response/#benefits-and-trade-offs-of-partial-response-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/partial-response/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/partial-response/#references-and-credits)
