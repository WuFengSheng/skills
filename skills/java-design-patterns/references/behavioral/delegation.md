---
name: "delegation"
description: "Delegation 委托 -- Behavioral设计模式。Explore the Delegation Design Pattern in Java with real-world examples, class diagrams, and its benefits. Learn how to enhance your code flexibility a"
url: "https://java-design-patterns.com/patterns/delegation/"
category: "behavioral"
tags: [Object composition, Delegation, Decoupling]
---

# Delegation 委托模式

> 官方文档: https://java-design-patterns.com/patterns/delegation/
> 分类: Behavioral (behavioral)
> 标签: Object composition, Delegation, Decoupling

BehavioralDecouplingDelegationObject compositionAbout 2 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/delegation/#also-known-as)

- Helper
- Surrogate

## [Intent of Delegation Design Pattern](https://java-design-patterns.com/patterns/delegation/#intent-of-delegation-design-pattern)

To allow an object to delegate responsibility for a task to another helper object.

## [Detailed Explanation of Delegation Pattern with Real-World Examples](https://java-design-patterns.com/patterns/delegation/#detailed-explanation-of-delegation-pattern-with-real-world-examples)
...
![Delegation sequence diagram](https://java-design-patterns.com/assets/img/delegation-sequence-diagram.ca137059.png)

## [Programmatic Example of Delegation Pattern in Java](https://java-design-patterns.com/patterns/delegation/#programmatic-example-of-delegation-pattern-in-java)
...
## [When to Use the Delegation Pattern in Java](https://java-design-patterns.com/patterns/delegation/#when-to-use-the-delegation-pattern-in-java)
...
## [Real-World Applications of Delegation Pattern in Java](https://java-design-patterns.com/patterns/delegation/#real-world-applications-of-delegation-pattern-in-java)
...
## [Benefits and Trade-offs of Delegation Pattern](https://java-design-patterns.com/patterns/delegation/#benefits-and-trade-offs-of-delegation-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/delegation/#related-java-design-patterns)
...
- [https://java-design-patterns.com/patterns/proxy/:](https://java-design-patterns.com/patterns/proxy/:) The proxy pattern is a form of delegation where a proxy object controls access to another object, which it delegates work to.

## [References and Credits](https://java-design-patterns.com/patterns/delegation/#references-and-credits)
