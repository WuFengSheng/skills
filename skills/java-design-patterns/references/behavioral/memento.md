---
name: "memento"
description: "Memento 备忘录 -- Behavioral设计模式。Learn how to implement the Memento design pattern in Java to capture and restore object state without violating encapsulation. Ideal for undo function"
url: "https://java-design-patterns.com/patterns/memento/"
category: "behavioral"
tags: [Undo, State tracking, Object composition, Memory management, Gang of Four, Encapsulation]
---

# Memento 备忘录模式

> 官方文档: https://java-design-patterns.com/patterns/memento/
> 分类: Behavioral (behavioral)
> 标签: Undo, State tracking, Object composition, Memory management, Gang of Four, Encapsulation

BehavioralEncapsulationGang of FourMemory managementObject compositionState trackingUndoAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/memento/#also-known-as)

- Snapshot
- Token

## [Intent of Memento Design Pattern](https://java-design-patterns.com/patterns/memento/#intent-of-memento-design-pattern)
...
## [Detailed Explanation of Memento Pattern with Real-World Examples](https://java-design-patterns.com/patterns/memento/#detailed-explanation-of-memento-pattern-with-real-world-examples)
...
![Memento sequence diagram](https://java-design-patterns.com/assets/img/memento-sequence-diagram.fdcea0d6.png)

## [Programmatic Example of Memento Pattern in Java](https://java-design-patterns.com/patterns/memento/#programmatic-example-of-memento-pattern-in-java)
...
## [When to Use the Memento Pattern in Java](https://java-design-patterns.com/patterns/memento/#when-to-use-the-memento-pattern-in-java)
...
## [Real-World Applications of Memento Pattern in Java](https://java-design-patterns.com/patterns/memento/#real-world-applications-of-memento-pattern-in-java)
...
## [Benefits and Trade-offs of Memento Pattern](https://java-design-patterns.com/patterns/memento/#benefits-and-trade-offs-of-memento-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/memento/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/memento/#references-and-credits)
