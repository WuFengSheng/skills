---
name: "identity-map"
description: "Identity Map 标识映射 -- Behavioral设计模式。Learn about the Identity Map pattern in Java. This design pattern prevents duplicate objects in memory, improving performance and consistency in your "
url: "https://java-design-patterns.com/patterns/identity-map/"
category: "behavioral"
tags: [Performance, Persistence, Object mapping, Enterprise patterns, Decoupling, Data access]
---

# Identity Map 标识映射模式

> 官方文档: https://java-design-patterns.com/patterns/identity-map/
> 分类: Behavioral (behavioral)
> 标签: Performance, Persistence, Object mapping, Enterprise patterns, Decoupling, Data access

BehavioralData accessDecouplingEnterprise patternsObject mappingPersistencePerformanceAbout 4 min

* * *

## [Intent of Identity Map Design Pattern](https://java-design-patterns.com/patterns/identity-map/#intent-of-identity-map-design-pattern)
...
## [Detailed Explanation of Identity Map Pattern with Real-World Examples](https://java-design-patterns.com/patterns/identity-map/#detailed-explanation-of-identity-map-pattern-with-real-world-examples)
...
![Identity Map sequence diagram](https://java-design-patterns.com/assets/img/identity-map-sequence-diagram.4d5c630e.png)

## [Programmatic Example of Identity Map Pattern in Java](https://java-design-patterns.com/patterns/identity-map/#programmatic-example-of-identity-map-pattern-in-java)
...
## [When to Use the Identity Map Pattern in Java](https://java-design-patterns.com/patterns/identity-map/#when-to-use-the-identity-map-pattern-in-java)
...
## [Identity Map Pattern Java Tutorials](https://java-design-patterns.com/patterns/identity-map/#identity-map-pattern-java-tutorials)

- [Identity Map Pattern (Source Code Examples)](https://www.sourcecodeexamples.net/2018/04/identity-map-pattern.html)

## [Real-World Applications of Identity Map Pattern in Java](https://java-design-patterns.com/patterns/identity-map/#real-world-applications-of-identity-map-pattern-in-java)
...
## [Benefits and Trade-offs of Identity Map Pattern](https://java-design-patterns.com/patterns/identity-map/#benefits-and-trade-offs-of-identity-map-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/identity-map/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/identity-map/#references-and-credits)
