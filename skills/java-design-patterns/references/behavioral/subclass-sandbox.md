...
description: "Subclass Sandbox 子类沙箱 -- 设计模式。Subclass Sandbox 设计模式 Java 实现"
url: "https://java-design-patterns.com/patterns/subclass-sandbox/"
category: "behavioral"
tags: []
---
...
> 官方文档: https://java-design-patterns.com/patterns/subclass-sandbox/
> 分类:  (behavioral)


BehavioralAbstractionCode simplificationDecouplingExtensibilityGame programmingPolymorphismAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/subclass-sandbox/#also-known-as)

- Hook Method

## [Intent of Subclass Sandbox Design Pattern](https://java-design-patterns.com/patterns/subclass-sandbox/#intent-of-subclass-sandbox-design-pattern)
...
## [Detailed Explanation of Subclass Sandbox Pattern with Real-World Examples](https://java-design-patterns.com/patterns/subclass-sandbox/#detailed-explanation-of-subclass-sandbox-pattern-with-real-world-examples)
...
![Subclass Sandbox flowchart](https://java-design-patterns.com/assets/img/subclass-sandbox-flowchart.3e77c3c2.png)

## [Programmatic Example of Subclass Sandbox Pattern in Java](https://java-design-patterns.com/patterns/subclass-sandbox/#programmatic-example-of-subclass-sandbox-pattern-in-java)
...
## [When to Use the Subclass Sandbox Pattern in Java](https://java-design-patterns.com/patterns/subclass-sandbox/#when-to-use-the-subclass-sandbox-pattern-in-java)
...
## [Real-World Applications of Subclass Sandbox Pattern in Java](https://java-design-patterns.com/patterns/subclass-sandbox/#real-world-applications-of-subclass-sandbox-pattern-in-java)
...
## [Benefits and Trade-offs of Subclass Sandbox Pattern](https://java-design-patterns.com/patterns/subclass-sandbox/#benefits-and-trade-offs-of-subclass-sandbox-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/subclass-sandbox/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/subclass-sandbox/#references-and-credits)
