---
name: "visitor"
description: "Visitor 访问者 -- Behavioral设计模式。Explore the Visitor design pattern in Java with detailed examples and class diagrams. Learn how to implement operations without altering object struct"
url: "https://java-design-patterns.com/patterns/visitor/"
category: "behavioral"
tags: [Polymorphism, Object composition, Gang of Four, Extensibility, Decoupling]
---

# Visitor 访问者模式

> 官方文档: https://java-design-patterns.com/patterns/visitor/
> 分类: Behavioral (behavioral)
> 标签: Polymorphism, Object composition, Gang of Four, Extensibility, Decoupling

BehavioralDecouplingExtensibilityGang of FourObject compositionPolymorphismAbout 4 min

* * *

## [Intent of Visitor Design Pattern](https://java-design-patterns.com/patterns/visitor/#intent-of-visitor-design-pattern)
...
## [Detailed Explanation of Visitor Pattern with Real-World Examples](https://java-design-patterns.com/patterns/visitor/#detailed-explanation-of-visitor-pattern-with-real-world-examples)
...
![Visitor sequence diagram](https://java-design-patterns.com/assets/img/visitor-sequence-diagram.9806c061.png)

## [Programmatic Example of Visitor Pattern in Java](https://java-design-patterns.com/patterns/visitor/#programmatic-example-of-visitor-pattern-in-java)
...
## [When to Use the Visitor Pattern in Java](https://java-design-patterns.com/patterns/visitor/#when-to-use-the-visitor-pattern-in-java)
...
## [Visitor Pattern Java Tutorials](https://java-design-patterns.com/patterns/visitor/#visitor-pattern-java-tutorials)
...
## [Real-World Applications of Visitor Pattern in Java](https://java-design-patterns.com/patterns/visitor/#real-world-applications-of-visitor-pattern-in-java)
...
## [Benefits and Trade-offs of Visitor Pattern](https://java-design-patterns.com/patterns/visitor/#benefits-and-trade-offs-of-visitor-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/visitor/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/visitor/#references-and-credits)
