...
description: "Double Dispatch 双分派 -- Behavioral设计模式。Learn the Double Dispatch Pattern in Java with detailed implementation examples. Understand how to use this design pattern to enhance your Java applic"
url: "https://java-design-patterns.com/patterns/double-dispatch/"
category: "behavioral"
tags: [Runtime, Polymorphism, Dynamic typing, Decoupling]
---

# Double Dispatch 双分派模式

> 官方文档: https://java-design-patterns.com/patterns/double-dispatch/
> 分类: Behavioral (behavioral)
> 标签: Runtime, Polymorphism, Dynamic typing, Decoupling

BehavioralDecouplingDynamic typingPolymorphismRuntimeAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/double-dispatch/#also-known-as)

- Multi-methods

## [Intent of Double Dispatch Design Pattern](https://java-design-patterns.com/patterns/double-dispatch/#intent-of-double-dispatch-design-pattern)
...
## [Detailed Explanation of Double Dispatch Pattern with Real-World Examples](https://java-design-patterns.com/patterns/double-dispatch/#detailed-explanation-of-double-dispatch-pattern-with-real-world-examples)
...
![Double Dispatch sequence diagram](https://java-design-patterns.com/assets/img/double-dispatch-sequence-diagram.51743973.png)

## [Programmatic Example of Double Dispatch Pattern in Java](https://java-design-patterns.com/patterns/double-dispatch/#programmatic-example-of-double-dispatch-pattern-in-java)
...
## [When to Use the Double Dispatch Pattern in Java](https://java-design-patterns.com/patterns/double-dispatch/#when-to-use-the-double-dispatch-pattern-in-java)
...
## [Real-World Applications of Double Dispatch Pattern in Java](https://java-design-patterns.com/patterns/double-dispatch/#real-world-applications-of-double-dispatch-pattern-in-java)
...
## [Benefits and Trade-offs of Double Dispatch Pattern](https://java-design-patterns.com/patterns/double-dispatch/#benefits-and-trade-offs-of-double-dispatch-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/double-dispatch/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/double-dispatch/#references-and-credits)
