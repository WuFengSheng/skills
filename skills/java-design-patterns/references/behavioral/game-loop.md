---
name: "game-loop"
description: "Game Loop 游戏循环 -- Behavioral设计模式。Learn about the Game Loop design pattern, its implementation in Java, and how it ensures smooth gameplay by continuously updating game state, processi"
url: "https://java-design-patterns.com/patterns/game-loop/"
category: "behavioral"
tags: [Performance, Game programming, Event-driven, Concurrency]
---

# Game Loop 游戏循环模式

> 官方文档: https://java-design-patterns.com/patterns/game-loop/
> 分类: Behavioral (behavioral)
> 标签: Performance, Game programming, Event-driven, Concurrency

BehavioralConcurrencyEvent-drivenGame programmingPerformanceAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/game-loop/#also-known-as)

- Game Cycle
- Main Game Loop

## [Intent of Game Loop Design Pattern](https://java-design-patterns.com/patterns/game-loop/#intent-of-game-loop-design-pattern)
...
## [Detailed Explanation of Game Loop Pattern with Real-World Examples](https://java-design-patterns.com/patterns/game-loop/#detailed-explanation-of-game-loop-pattern-with-real-world-examples)
...
![Game Loop flowchart](https://java-design-patterns.com/assets/img/game-loop-flowchart.890b0ea5.png)

## [Programmatic Example of Game Loop Pattern in Java](https://java-design-patterns.com/patterns/game-loop/#programmatic-example-of-game-loop-pattern-in-java)
...
## [When to Use the Game Loop Pattern in Java](https://java-design-patterns.com/patterns/game-loop/#when-to-use-the-game-loop-pattern-in-java)
...
## [Real-World Applications of Game Loop Pattern in Java](https://java-design-patterns.com/patterns/game-loop/#real-world-applications-of-game-loop-pattern-in-java)
...
## [Benefits and Trade-offs of Game Loop Pattern](https://java-design-patterns.com/patterns/game-loop/#benefits-and-trade-offs-of-game-loop-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/game-loop/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/game-loop/#references-and-credits)
