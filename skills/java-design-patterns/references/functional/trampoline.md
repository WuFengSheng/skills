---
name: "trampoline"
description: "Trampoline 蹦床 -- Functional设计模式。Discover how to implement the Trampoline pattern in Java to efficiently manage recursive functions and prevent stack overflow errors, with real-world "
url: "https://java-design-patterns.com/patterns/trampoline/"
category: "functional"
tags: [Recursion, Performance, Functional decomposition, Code simplification]
---

# Trampoline 蹦床模式

> 官方文档: https://java-design-patterns.com/patterns/trampoline/
> 分类: Functional (functional)
> 标签: Recursion, Performance, Functional decomposition, Code simplification

FunctionalCode simplificationFunctional decompositionPerformanceRecursionAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/trampoline/#also-known-as)

- Bounce
- Tail-Call Optimization

## [Intent of Trampoline Design Pattern](https://java-design-patterns.com/patterns/trampoline/#intent-of-trampoline-design-pattern)
...
## [Detailed Explanation of Trampoline Pattern with Real-World Examples](https://java-design-patterns.com/patterns/trampoline/#detailed-explanation-of-trampoline-pattern-with-real-world-examples)
...
![Trampoline Pattern Flowchart](https://java-design-patterns.com/assets/img/trampoline-flowchart.dd567bc7.png)

## [Programmatic Example of Trampoline Pattern in Java](https://java-design-patterns.com/patterns/trampoline/#programmatic-example-of-trampoline-pattern-in-java)
...
## [When to Use the Trampoline Pattern in Java](https://java-design-patterns.com/patterns/trampoline/#when-to-use-the-trampoline-pattern-in-java)
...
## [Trampoline Pattern Java Tutorials](https://java-design-patterns.com/patterns/trampoline/#trampoline-pattern-java-tutorials)
...
## [Real-World Applications of Trampoline Pattern in Java](https://java-design-patterns.com/patterns/trampoline/#real-world-applications-of-trampoline-pattern-in-java)
...
## [Benefits and Trade-offs of Trampoline Pattern](https://java-design-patterns.com/patterns/trampoline/#benefits-and-trade-offs-of-trampoline-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/trampoline/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/trampoline/#references-and-credits)
