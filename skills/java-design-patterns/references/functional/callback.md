---
name: "callback"
description: "Callback 回调 -- Functional设计模式。Learn about the Java Callback Design Pattern, including its intent, usage scenarios, benefits, trade-offs, and real-world examples. Understand how to "
url: "https://java-design-patterns.com/patterns/callback/"
category: "functional"
tags: [Reactive, Idiom, Decoupling, Asynchronous]
---

# Callback 回调模式

> 官方文档: https://java-design-patterns.com/patterns/callback/
> 分类: Functional (functional)
> 标签: Reactive, Idiom, Decoupling, Asynchronous

FunctionalAsynchronousDecouplingIdiomReactiveAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/callback/#also-known-as)

- Call-After
- Event-Subscription
- Listener

## [Intent of Callback Design Pattern](https://java-design-patterns.com/patterns/callback/#intent-of-callback-design-pattern)
...
## [Detailed Explanation of Callback Pattern with Real-World Examples](https://java-design-patterns.com/patterns/callback/#detailed-explanation-of-callback-pattern-with-real-world-examples)
...
![Callback sequence diagram](https://java-design-patterns.com/assets/img/callback-sequence-diagram.de49447e.png)

## [Programmatic Example of Callback Pattern in Java](https://java-design-patterns.com/patterns/callback/#programmatic-example-of-callback-pattern-in-java)
...
## [When to Use the Callback Pattern in Java](https://java-design-patterns.com/patterns/callback/#when-to-use-the-callback-pattern-in-java)
...
## [Real-World Applications of Callback Pattern in Java](https://java-design-patterns.com/patterns/callback/#real-world-applications-of-callback-pattern-in-java)
...
## [Benefits and Trade-offs of Callback Pattern](https://java-design-patterns.com/patterns/callback/#benefits-and-trade-offs-of-callback-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/callback/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/callback/#references-and-credits)
