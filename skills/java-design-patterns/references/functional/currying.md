---
name: "currying"
description: "Currying 柯里化 -- Functional设计模式。Learn about currying in Java, a technique to simplify functions by breaking them into a sequence of single-argument functions. Discover its applicatio"
url: "https://java-design-patterns.com/patterns/currying/"
category: "functional"
tags: [Immutable, Generic, Functional decomposition, Code simplification]
---

# Currying 柯里化模式

> 官方文档: https://java-design-patterns.com/patterns/currying/
> 分类: Functional (functional)
> 标签: Immutable, Generic, Functional decomposition, Code simplification

FunctionalCode simplificationFunctional decompositionGenericImmutableAbout 5 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/currying/#also-known-as)

- Partial Function Application

## [Intent of Currying Design Pattern](https://java-design-patterns.com/patterns/currying/#intent-of-currying-design-pattern)
...
## [Detailed Explanation of Currying Pattern with Real-World Examples](https://java-design-patterns.com/patterns/currying/#detailed-explanation-of-currying-pattern-with-real-world-examples)
...
![Currying sequence diagram](https://java-design-patterns.com/assets/img/currying-sequence-diagram.6c23bcb3.png)

## [Programmatic example of Currying Pattern in Java](https://java-design-patterns.com/patterns/currying/#programmatic-example-of-currying-pattern-in-java)
...
## [When to Use the Currying Pattern in Java](https://java-design-patterns.com/patterns/currying/#when-to-use-the-currying-pattern-in-java)
...
## [Currying Pattern Java Tutorials](https://java-design-patterns.com/patterns/currying/#currying-pattern-java-tutorials)
...
## [Real-World Applications of Currying Pattern in Java](https://java-design-patterns.com/patterns/currying/#real-world-applications-of-currying-pattern-in-java)
...
## [Benefits and Trade-offs of Currying Pattern](https://java-design-patterns.com/patterns/currying/#benefits-and-trade-offs-of-currying-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/currying/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/currying/#references-and-credits)
