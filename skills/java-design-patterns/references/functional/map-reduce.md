---
name: "map-reduce"
description: "MapReduce MapReduce -- Functional设计模式。Learn the MapReduce pattern in Java with real-world examples, class diagrams, and tutorials. Understand its intent, applicability, benefits, and known"
url: "https://java-design-patterns.com/patterns/map-reduce/"
category: "functional"
tags: [Scalability, Multithreading, Immutable, Functional decomposition, Data transformation, Data processing, Concurrency]
---

# MapReduce MapReduce模式

> 官方文档: https://java-design-patterns.com/patterns/map-reduce/
> 分类: Functional (functional)
> 标签: Scalability, Multithreading, Immutable, Functional decomposition, Data transformation, Data processing, Concurrency

FunctionalConcurrencyData processingData transformationFunctional decompositionImmutableMultithreadingScalabilityAbout 4 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/map-reduce/#also-known-as)

- Map-Reduce
- Divide and Conquer for Data Processing

## [Intent of Map Reduce Design Pattern](https://java-design-patterns.com/patterns/map-reduce/#intent-of-map-reduce-design-pattern)
...
## [Detailed Explanation of Map Reduce Pattern with Real-World Examples](https://java-design-patterns.com/patterns/map-reduce/#detailed-explanation-of-map-reduce-pattern-with-real-world-examples)
...
![MapReduce flowchart](https://java-design-patterns.com/assets/img/mapreduce-flowchart.37cbbec1.png)

## [Programmatic Example of Map Reduce in Java](https://java-design-patterns.com/patterns/map-reduce/#programmatic-example-of-map-reduce-in-java)

### [1\. Map Phase (Splitting & Processing Data)](https://java-design-patterns.com/patterns/map-reduce/#_1-map-phase-splitting-processing-data)

- Each input string is split into words, normalized, and counted.
- Output: A map `{word → count}` for each input string.

#### [`Mapper.java`](https://java-design-patterns.com/patterns/map-reduce/#mapper-java)
...
### [2\. Shuffle Phase – Grouping Words Across Inputs](https://java-design-patterns.com/patterns/map-reduce/#_2-shuffle-phase-%E2%80%93-grouping-words-across-inputs)

- Takes results from all mappers and groups values by word.
- Output: A map `{word → list of counts}`.

#### [`Shuffler.java`](https://java-design-patterns.com/patterns/map-reduce/#shuffler-java)
...
### [3\. Reduce Phase – Aggregating Counts](https://java-design-patterns.com/patterns/map-reduce/#_3-reduce-phase-%E2%80%93-aggregating-counts)

- Sums the list of counts for each word.
- Output: A sorted list of word counts in descending order.

#### [`Reducer.java`](https://java-design-patterns.com/patterns/map-reduce/#reducer-java)
...
### [4\. MapReduce Coordinator – Running the Whole Pipeline](https://java-design-patterns.com/patterns/map-reduce/#_4-mapreduce-coordinator-%E2%80%93-running-the-whole-pipeline)

- Coordinates map, shuffle, and reduce phases.

#### [`MapReduce.java`](https://java-design-patterns.com/patterns/map-reduce/#mapreduce-java)
...
### [5\. Main Execution – Example Usage](https://java-design-patterns.com/patterns/map-reduce/#_5-main-execution-%E2%80%93-example-usage)

- Runs the MapReduce process and prints results.

#### [`Main.java`](https://java-design-patterns.com/patterns/map-reduce/#main-java)
...
## [When to Use the Map Reduce Pattern in Java](https://java-design-patterns.com/patterns/map-reduce/#when-to-use-the-map-reduce-pattern-in-java)
...
## [Map Reduce Pattern Java Tutorials](https://java-design-patterns.com/patterns/map-reduce/#map-reduce-pattern-java-tutorials)
...
## [Benefits and Trade-offs of Map Reduce Pattern](https://java-design-patterns.com/patterns/map-reduce/#benefits-and-trade-offs-of-map-reduce-pattern)
...
## [Real-World Applications of Map Reduce Pattern in Java](https://java-design-patterns.com/patterns/map-reduce/#real-world-applications-of-map-reduce-pattern-in-java)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/map-reduce/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/map-reduce/#references-and-credits)
