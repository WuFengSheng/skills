---
name: "poison-pill"
description: "Poison Pill 毒丸 -- Concurrency设计模式。Explore the Poison Pill design pattern in Java, used for gracefully shutting down multi-threaded applications. Understand its intent, applicability, a"
url: "https://java-design-patterns.com/patterns/poison-pill/"
category: "concurrency"
tags: [Thread management, Messaging, Fault tolerance, Decoupling]
---

# Poison Pill 毒丸模式

> 官方文档: https://java-design-patterns.com/patterns/poison-pill/
> 分类: Concurrency (concurrency)
> 标签: Thread management, Messaging, Fault tolerance, Decoupling

ConcurrencyDecouplingFault toleranceMessagingThread managementAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/poison-pill/#also-known-as)

- Shutdown Signal

## [Intent of Poison Pill Design Pattern](https://java-design-patterns.com/patterns/poison-pill/#intent-of-poison-pill-design-pattern)
...
## [Detailed Explanation of Poison Pill Pattern with Real-World Examples](https://java-design-patterns.com/patterns/poison-pill/#detailed-explanation-of-poison-pill-pattern-with-real-world-examples)
...
![Poison Pill sequence diagram](https://java-design-patterns.com/assets/img/poison-pill-sequence-diagram.1fd1a9ed.png)

## [Programmatic Example of Poison Pill Pattern in Java](https://java-design-patterns.com/patterns/poison-pill/#programmatic-example-of-poison-pill-pattern-in-java)
...
## [When to Use the Poison Pill Pattern in Java](https://java-design-patterns.com/patterns/poison-pill/#when-to-use-the-poison-pill-pattern-in-java)
...
## [Real-World Applications of Poison Pill Pattern in Java](https://java-design-patterns.com/patterns/poison-pill/#real-world-applications-of-poison-pill-pattern-in-java)
...
## [Benefits and Trade-offs of Poison Pill Pattern](https://java-design-patterns.com/patterns/poison-pill/#benefits-and-trade-offs-of-poison-pill-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/poison-pill/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/poison-pill/#references-and-credits)
