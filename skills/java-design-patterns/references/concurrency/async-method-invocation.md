---
name: "async-method-invocation"
description: "Async Method Invocation 异步方法调用 -- 设计模式。Async Method Invocation 设计模式 Java 实现"
url: "https://java-design-patterns.com/patterns/async-method-invocation/"
...
> 官方文档: https://java-design-patterns.com/patterns/async-method-invocation/
> 分类:  (concurrency)


ConcurrencyAsynchronousDecouplingReactiveScalabilityThread managementAbout 5 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/async-method-invocation/#also-known-as)

- Asynchronous Procedure Call

## [Intent of Async Method Invocation Design Pattern](https://java-design-patterns.com/patterns/async-method-invocation/#intent-of-async-method-invocation-design-pattern)
...
## [Detailed Explanation of Async Method Invocation Pattern with Real-World Examples](https://java-design-patterns.com/patterns/async-method-invocation/#detailed-explanation-of-async-method-invocation-pattern-with-real-world-examples)
...
![Async Method Invocation sequence diagram](https://java-design-patterns.com/assets/img/async-method-invocation-sequence-diagram.e58675b7.png)

## [Programmatic Example of Async Method Invocation Pattern in Java](https://java-design-patterns.com/patterns/async-method-invocation/#programmatic-example-of-async-method-invocation-pattern-in-java)
...
## [When to Use the Async Method Invocation Pattern in Java](https://java-design-patterns.com/patterns/async-method-invocation/#when-to-use-the-async-method-invocation-pattern-in-java)
...
## [Real-World Applications of Async Method Invocation Pattern in Java](https://java-design-patterns.com/patterns/async-method-invocation/#real-world-applications-of-async-method-invocation-pattern-in-java)
...
## [Benefits and Trade-offs of Async Method Invocation Pattern](https://java-design-patterns.com/patterns/async-method-invocation/#benefits-and-trade-offs-of-async-method-invocation-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/async-method-invocation/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/async-method-invocation/#references-and-credits)
