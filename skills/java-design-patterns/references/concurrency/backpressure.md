---
name: "backpressure"
description: "Backpressure 背压 -- Concurrency设计模式。Dive into the Backpressure design pattern in Java through practical examples, discovering how it prevents overload while ensuring stability and peak p"
url: "https://java-design-patterns.com/patterns/backpressure/"
category: "concurrency"
tags: [Resilience, Reactive, Event-driven, Asynchronous]
---

# Backpressure 背压模式

> 官方文档: https://java-design-patterns.com/patterns/backpressure/
> 分类: Concurrency (concurrency)
> 标签: Resilience, Reactive, Event-driven, Asynchronous

ConcurrencyAsynchronousEvent-drivenReactiveResilienceAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/backpressure/#also-known-as)

- Flow Control
- Rate Limiting Mechanism

## [Intent of the Backpressure Design Pattern](https://java-design-patterns.com/patterns/backpressure/#intent-of-the-backpressure-design-pattern)

Control the rate of data production so downstream consumers are not overwhelmed by excessive load.

## [Detailed Explanation of Backpressure Pattern with Real-World Examples](https://java-design-patterns.com/patterns/backpressure/#detailed-explanation-of-backpressure-pattern-with-real-world-examples)
...
![Backpressure sequence diagram](https://java-design-patterns.com/assets/img/backpressure-sequence-diagram.4b053038.png)

## [Programmatic Example of Backpressure Pattern in Java](https://java-design-patterns.com/patterns/backpressure/#programmatic-example-of-backpressure-pattern-in-java)
...
## [When to Use the Backpressure Pattern In Java](https://java-design-patterns.com/patterns/backpressure/#when-to-use-the-backpressure-pattern-in-java)
...
## [Benefits and Trade-offs of Backpressure Pattern](https://java-design-patterns.com/patterns/backpressure/#benefits-and-trade-offs-of-backpressure-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/backpressure/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/backpressure/#references-and-credits)
