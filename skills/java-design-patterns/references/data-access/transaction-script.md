...
description: "Transaction Script 事务脚本 -- Data access设计模式。Explore the Transaction Script design pattern for Java applications. Learn how to organize simple business logic into efficient scripts with real-worl"
url: "https://java-design-patterns.com/patterns/transaction-script/"
category: "data-access"
tags: [Transactions, Persistence, Domain, Data access, Business]
---

# Transaction Script 事务脚本模式

> 官方文档: https://java-design-patterns.com/patterns/transaction-script/
> 分类: Data access (data-access)
> 标签: Transactions, Persistence, Domain, Data access, Business

Data accessBusinessData accessDomainPersistenceTransactionsAbout 5 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/transaction-script/#also-known-as)

- Scripted Transactions

## [Intent of Transaction Script Design Pattern](https://java-design-patterns.com/patterns/transaction-script/#intent-of-transaction-script-design-pattern)
...
## [Detailed Explanation of Transaction Script Pattern with Real-World Examples](https://java-design-patterns.com/patterns/transaction-script/#detailed-explanation-of-transaction-script-pattern-with-real-world-examples)
...
![Transaction Script Pattern Flowchart](https://java-design-patterns.com/assets/img/transaction-script-flowchart.4399260b.png)

## [Programmatic Example of Transaction Script Pattern in Java](https://java-design-patterns.com/patterns/transaction-script/#programmatic-example-of-transaction-script-pattern-in-java)
...
01. A new H2 database data source is created using the `createDataSource()` method. This data source is used to interact with the in-memory H2 database.

02. The existing schema (if any) in the database is deleted using the `deleteSchema(dataSource)` method. This is done to ensure a clean state before the application starts.

03. A new schema is created in the database using the `createSchema(dataSource)` method. The schema includes the necessary tables and relationships for the application.

04. An instance of `HotelDaoImpl` is created, which serves as the Data Access Object (DAO). This object is responsible for handling the database operations related to the hotel rooms.

05. Sample rooms are added to the hotel using the `addRooms(dao)` method. This method generates a list of sample rooms and adds them to the hotel via the DAO.

06. The booking status of all rooms is printed using the `getRoomStatus(dao)` method.

07. An instance of `Hotel` is created with the DAO as a parameter. This object represents the hotel and provides methods to book and cancel room bookings.

08. Several rooms are booked using the `hotel.bookRoom(roomNumber)` method.

09. Some of the bookings are then cancelled using the `hotel.cancelRoomBooking(roomNumber)` method.
...
## [When to Use the Transaction Script Pattern in Java](https://java-design-patterns.com/patterns/transaction-script/#when-to-use-the-transaction-script-pattern-in-java)
...
## [Transaction Script Pattern Java Tutorials](https://java-design-patterns.com/patterns/transaction-script/#transaction-script-pattern-java-tutorials)
...
## [Real-World Applications of Transaction Script Pattern in Java](https://java-design-patterns.com/patterns/transaction-script/#real-world-applications-of-transaction-script-pattern-in-java)
...
## [Benefits and Trade-offs of Transaction Script Pattern](https://java-design-patterns.com/patterns/transaction-script/#benefits-and-trade-offs-of-transaction-script-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/transaction-script/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/transaction-script/#references-and-credits)
