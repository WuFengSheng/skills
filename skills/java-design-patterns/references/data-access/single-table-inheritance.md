...
description: "Single Table Inheritance 单表继承 -- Data access设计模式。Discover how the Single Table Inheritance pattern simplifies database schema in Java applications. Learn its use, benefits, and implementation in our "
url: "https://java-design-patterns.com/patterns/single-table-inheritance/"
category: "data-access"
tags: [Polymorphism, Persistence, Encapsulation, Data access]
---

# Single Table Inheritance 单表继承模式

> 官方文档: https://java-design-patterns.com/patterns/single-table-inheritance/
> 分类: Data access (data-access)
> 标签: Polymorphism, Persistence, Encapsulation, Data access

Data accessData accessEncapsulationPersistencePolymorphismAbout 6 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/single-table-inheritance/#also-known-as)

- Class Table Inheritance
- STI

## [Intent of Single Table Inheritance Design Pattern](https://java-design-patterns.com/patterns/single-table-inheritance/#intent-of-single-table-inheritance-design-pattern)
...
## [Detailed Explanation of Single Table Inheritance Pattern with Real-World Examples](https://java-design-patterns.com/patterns/single-table-inheritance/#detailed-explanation-of-single-table-inheritance-pattern-with-real-world-examples)
...
![Single Table Inheritance flowchart](https://java-design-patterns.com/assets/img/single-table-inheritance-flowchart.bbe09265.png)

## [Programmatic Example of Single Table Inheritance Pattern in Java](https://java-design-patterns.com/patterns/single-table-inheritance/#programmatic-example-of-single-table-inheritance-pattern-in-java)
...
## [When to Use the Single Table Inheritance Pattern in Java](https://java-design-patterns.com/patterns/single-table-inheritance/#when-to-use-the-single-table-inheritance-pattern-in-java)
...
## [Single Table Inheritance Pattern Tutorials](https://java-design-patterns.com/patterns/single-table-inheritance/#single-table-inheritance-pattern-tutorials)
...
## [Real-World Applications of Single Table Inheritance Pattern in Java](https://java-design-patterns.com/patterns/single-table-inheritance/#real-world-applications-of-single-table-inheritance-pattern-in-java)
...
## [Benefits and Trade-offs of Single Table Inheritance Pattern](https://java-design-patterns.com/patterns/single-table-inheritance/#benefits-and-trade-offs-of-single-table-inheritance-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/single-table-inheritance/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/single-table-inheritance/#references-and-credits)
