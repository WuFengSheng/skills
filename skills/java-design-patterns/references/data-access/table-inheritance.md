...
description: "Table Inheritance 表继承 -- Data access设计模式。Explore the Table Inheritance pattern in Java with real-world examples, database schema, and tutorials. Learn how to model class hierarchies elegantly"
url: "https://java-design-patterns.com/patterns/table-inheritance/"
category: "data-access"
tags: [Polymorphism, Persistence, Inheritance, Database, Data access]
---

# Table Inheritance 表继承模式

> 官方文档: https://java-design-patterns.com/patterns/table-inheritance/
> 分类: Data access (data-access)
> 标签: Polymorphism, Persistence, Inheritance, Database, Data access

Data accessData accessDatabaseInheritancePersistencePolymorphismAbout 3 min

* * *

## [Also known as](https://java-design-patterns.com/patterns/table-inheritance/#also-known-as)

- Class Table Inheritance
- Joined Table Inheritance

## [Intent of Table Inheritance Pattern](https://java-design-patterns.com/patterns/table-inheritance/#intent-of-table-inheritance-pattern)

Represent inheritance hierarchies in relational databases by mapping each class in a hierarchy to a database table.

## [Detailed Explanation of Table Inheritance Pattern with Real-World Examples](https://java-design-patterns.com/patterns/table-inheritance/#detailed-explanation-of-table-inheritance-pattern-with-real-world-examples)
...
![Table Inheritance Pattern Mind Map](https://java-design-patterns.com/assets/img/table-inheritance-mind-map.43e55367.png)

## [Programmatic Example of Table Inheritance Pattern in Java](https://java-design-patterns.com/patterns/table-inheritance/#programmatic-example-of-table-inheritance-pattern-in-java)
...
### [Key Aspects of the Pattern:](https://java-design-patterns.com/patterns/table-inheritance/#key-aspects-of-the-pattern)
...
### [Java Implementation Using JPA Annotations:](https://java-design-patterns.com/patterns/table-inheritance/#java-implementation-using-jpa-annotations)
...
### [Explanation of the JPA annotations used above:](https://java-design-patterns.com/patterns/table-inheritance/#explanation-of-the-jpa-annotations-used-above)
...
### [Database Structure Result:](https://java-design-patterns.com/patterns/table-inheritance/#database-structure-result)
...
## [When to Use the Table Inheritance Pattern in Java](https://java-design-patterns.com/patterns/table-inheritance/#when-to-use-the-table-inheritance-pattern-in-java)
...
## [Table Inheritance Pattern Java Tutorials](https://java-design-patterns.com/patterns/table-inheritance/#table-inheritance-pattern-java-tutorials)
...
## [Real-World Applications of Table Inheritance Pattern in Java](https://java-design-patterns.com/patterns/table-inheritance/#real-world-applications-of-table-inheritance-pattern-in-java)
...
## [Benefits and Trade-offs of Table Inheritance Pattern](https://java-design-patterns.com/patterns/table-inheritance/#benefits-and-trade-offs-of-table-inheritance-pattern)
...
## [Related Java Design Patterns](https://java-design-patterns.com/patterns/table-inheritance/#related-java-design-patterns)
...
## [References and Credits](https://java-design-patterns.com/patterns/table-inheritance/#references-and-credits)
